...
namespace Controllers {
    ...
    abstract class RequestAbstract {
        ...
        public function __construct($request) {
			...
			file_put_contents('php://stderr', "*****************requestabstract************");
            file_put_contents('php://stderr', print_r($this->request, TRUE));
			file_put_contents('php://stderr', print_r($this->header, TRUE));
