...
namespace Controllers {
    ...
    class RequestHandler extends RequestAbstract {
        ...
        public function __construct($request, $origin) {
            ...
            if ($this->endpoint == 'calllog' || $this->endpoint == 'contactentry')
            {
        ...
        //CallLog details
        protected function calllog() {
            $calllog = new CallLog($this->method . '_' . $this->verb);
            return $calllog->{$this->method . '_' . $this->verb}($this->args, $this->request);
        }

        //ContactEntry details
        protected function contactentry() {
            $calllog = new ContactEntry($this->method . '_' . $this->verb);
            return $calllog->{$this->method . '_' . $this->verb}($this->args, $this->request);
        }
