Application.Crm_AssociatPartner = (function () {
    var winsize = Ext.getBody().getViewSize();
    var modURL = "?module=crm_associate_partner";
    ...
    var gridSelectionChangedaaContact = function (sm) {
      if (
        !Ext.isEmpty(
          Ext.getCmp(
            "gridAssociatePartnerContacts" + Application.Crm_AssociatPartner.Cache.typeName
          )
            .getSelectionModel()
            .getSelections()
        )
        ...
        Ext.getCmp(
          "tabpanelAssociatePartnerContact" + Application.Crm_AssociatPartner.Cache.typeName
        ).setActiveTab(0);
        Application.Crm_AssociatPartner.Cache.aaId = ID;
        Application.Crm_AssociatPartner.ViewModeContact(ID);
      } else {
        Application.Crm_AssociatPartner.Cache.aaId = 0;
        Application.Crm_AssociatPartner.ViewModeContact(0);
      }
    };
    var associatePartnerContactPanel = function (id, typeName) {
      var contactsPanel = new Ext.Panel({
        ...
        hideBorders: true,
        title: "Associate Partner Contacts",
        id: id,
    ...
    var tableCotactDetails = function () {
      ...
      var src =
        ...
        Application.Crm_AssociatPartner.Cache.aaId +
        "&tstamp=" +
        t_stamp +
        "&apikey=" +
        apikey;
      var contactsPanel = new Ext.Panel({
        id: "tableCrmContactsDataview" + Application.Crm_AssociatPartner.Cache.typeName,
        region: "center",
        ...
        items: [
          {
            ...
            html:
              ...
              Application.Crm_AssociatPartner.Cache.typeName +
            ...
            switch (tab.title) {
              case "Log":
                Ext.getCmp('gridCommunicationListContact').getStore().load({
                  params:{
                    aaId: Application.Crm_AssociatPartner.Cache.aaId
                  }
                });
                break;
            }
      ...
      return new Ext.data.GroupingStore({
        ...
        listeners: {
          ...
          beforeload: function (store, e) {
            ...
            this.baseParams.type = Application.Crm_AssociatPartner.Cache.type;
          },
        },
      });
    };
    ...
    function initAutocompleteText() {
      ...
      autocomplete.addListener("place_changed", function () {
        ...
        Ext.getCmp('preferredArea').getStore().load({
          params: {"locationGlatitude": latitude,"locationGlongitude": longitude}
        });
    ...
    var APContactForm = function (contactid) {
      ...
      var APContactForm = new Ext.Window({
        width: 500,
        autoHeight: true,
        id: "add_contactWindow" + Application.Crm_AssociatPartner.Cache.typeName,
        shadow: false,
        resizable: false,
        plain: true,
        constrain: true,
        ...
        items: [
          new Ext.form.FormPanel({
            id: "formpanelAddContact" + Application.Crm_AssociatPartner.Cache.typeName,
                    ...
                    items: [
                      {
                        ...
                        listeners: {
                          focus: function () {
                            ...
                            Ext.getCmp("preferredArea").getStore().clearData();
                            Ext.getCmp('preferredArea').getStore().load({
                              params: {
                                "locationGlatitude": Ext.getCmp('locationGlatitude').getValue(),
                                "locationGlongitude": Ext.getCmp('locationGlongitude').getValue()
                              }
                          });
                          }
                        },
          ...
          },
          {
            ...
            handler: function () {
              ...
              var _addContactData = Ext.getCmp(
                "formpanelAddContact" + Application.Crm_AssociatPartner.Cache.typeName
              ); 
      ...
      if (contactid > 0) {
        ...
        regFee_form.load({
          ...
          success: function (form, action) {
            ...
            console.log(tmp);            
            Ext.getCmp('preferredArea').setValue(tmp.data.preferredArea);
            Ext.getCmp('preferredArea').getStore().load({
              params: {"locationGlatitude": tmp.data.locationGlatitude,"locationGlongitude": tmp.data.locationGlongitude}
          });
          if(!Ext.isEmpty(tmp.data.as_dst_Id)){
            Ext.getCmp('as_st_id').show();
            ...
            Ext.getCmp('as_dst_Id').getStore().load({
              baseParams: {"st_Id": tmp.data.as_st_id}
            });
          }
    ...
    var contactInsertion = function (areaAssociateId) {
      ...
      if (areaAssociateId > 0) {
        ...
        Application.Crm_AssociatPartner.Cache.upcrocid = areaAssociateId;
      } else {
        areaAssociateId = "-";
        Application.Crm_AssociatPartner.Cache.upcrocid = 0;
      }
      if (_addeditform.getForm().isValid()) {
        Application.Crm_AssociatPartner.insertData();
      } else {
    ...
    var associatePartnerEnquiryPanel = function (id, typeName) {
      var contactsPanel = new Ext.Panel({
        ...
        bodyStyle: { "background-color": "white" },
        hideBorders: true,
        title: "Associate Partner Enquiry",
        id: id,
    ...
    var gridSelectionChangedaaEnquiry = function (sm) {
      if (
        !Ext.isEmpty(
          Ext.getCmp(
            "gridAssociatePartnerEnquiry" + Application.Crm_AssociatPartner.Cache.typeName
          )
            .getSelectionModel()
            .getSelections()
        )
        ...
        var ID = Ext.getCmp(
          ...
          .getSelections()[0].data.aaId;
        Ext.getCmp(
          "tabpanelAssociatePartnerEnquiry" + Application.Crm_AssociatPartner.Cache.typeName
        ).setActiveTab(0);
        Application.Crm_AssociatPartner.Cache.aaId = ID;
        Application.Crm_AssociatPartner.ViewModeEnquiry(ID);
      } else {
        Application.Crm_AssociatPartner.Cache.aaId = 0;
        Application.Crm_AssociatPartner.ViewModeEnquiry(0);
      }
    };
    ...
    var tableEnquiryDetails = function () {
      ...
      var enquiryPanel = new Ext.Panel({
        id: "tableCrmEnquiryDataview" + Application.Crm_AssociatPartner.Cache.typeName,
        region: "center",
        width: winsize.width * 0.39,
        items: [
          {
    ...
    var gridSelectionChangedaaLead = function (sm) {
      if (
        !Ext.isEmpty(
          Ext.getCmp(
            "gridAssociatePartnerLead" + Application.Crm_AssociatPartner.Cache.typeName
          )
            .getSelectionModel()
            .getSelections()
        )
        ...
        var ID = Ext.getCmp(
          ...
          .getSelections()[0].data.aaId;
        Ext.getCmp(
          "tabpanelAssociatePartnerLead" + Application.Crm_AssociatPartner.Cache.typeName
        ).setActiveTab(0);
        Application.Crm_AssociatPartner.Cache.aaId = ID;
        Application.Crm_AssociatPartner.ViewModeLead(ID);
      } else {
        Application.Crm_AssociatPartner.Cache.aaId = 0;
        Application.Crm_AssociatPartner.ViewModeLead(0);
      }
    };
    ...
    var tableLeadDetails = function () {
      ...
      var leadPanel = new Ext.Panel({
        id: "tableCrmLeadDataview" + Application.Crm_AssociatPartner.Cache.typeName,
        region: "center",
        width: winsize.width * 0.39,
        items: [
          {
      ...
      var cpfrmLeadWindow = new Ext.Window({
        ...
        items: [
          new Ext.FormPanel({
            layout: "form",
            id:
              "upgradeLeadStageFormPanel" + Application.Crm_AssociatPartner.Cache.typeName,
            height: 150,
            columnWidth: 1,
            frame: true,
            border: true,
    ...
    var associatePartnerProspectPanel = function (id, typeName) {
      var prospectsPanel = new Ext.Panel({
        ...
        bodyStyle: { "background-color": "white" },
        hideBorders: true,
        title: "Associate Partner Prospect",
        id: id,
    ...
    var gridSelectionChangedaaProspect = function (sm) {
      if (
        !Ext.isEmpty(
          Ext.getCmp(
            "gridAssociatePartnerProspect" + Application.Crm_AssociatPartner.Cache.typeName
          )
            .getSelectionModel()
            .getSelections()
        )
        ...
        var ID = Ext.getCmp(
          ...
          .getSelections()[0].data.aaId;
        Ext.getCmp(
          "tabpanelAssociatePartnerProspect" + Application.Crm_AssociatPartner.Cache.typeName
        ).setActiveTab(0);
        Application.Crm_AssociatPartner.Cache.aaId = ID;
        Application.Crm_AssociatPartner.ViewModeProspect(ID);
      } else {
        Application.Crm_AssociatPartner.Cache.aaId = 0;
        Application.Crm_AssociatPartner.ViewModeProspect(0);
      }
    };
    ...
    var tableProspectDetails = function () {
      ...
      var prospectPanel = new Ext.Panel({
        id: "tableCrmProspectDataview" + Application.Crm_AssociatPartner.Cache.typeName,
        region: "center",
        width: winsize.width * 0.39,
        items: [
          {
        ...
        items: [          
          {
            ...
            handler: function () {
              var aaId = Ext.getCmp("gridAssociatePartnerProspect" + typeName)
                .getSelectionModel()
                .getSelections()[0].data.aaId;
                  Application.Crm_AssociatPartner.approveProspect(aaId,typeName);              
    ...
    var APProspectForm = function (prospectid) {
      ...
      var APProspectForm = new Ext.Window({
        width: 500,
        autoHeight: true,
        id: "add_prospectWindow" + Application.Crm_AssociatPartner.Cache.typeName,
        shadow: false,
        resizable: false,
        plain: true,
        constrain: true,
        ...
        items: [
          new Ext.form.FormPanel({
            id: "formpanelAddProspect" + Application.Crm_AssociatPartner.Cache.typeName,
        ...
        fbar: [
          {
            ...
            tabIndex: 311,
            handler: function () {
              Ext.getCmp("gridAssociatePartnerProspect" +Application.Crm_AssociatPartner.Cache.typeName).getStore().load();
          ...
          },
          {
            ...
            handler: function () {
              ...
              var _addProspectData = Ext.getCmp(
                "formpanelAddProspect" + Application.Crm_AssociatPartner.Cache.typeName
              ); 
    ...
    var prospectInsertion = function (areaAssociateId) {
      ...
      if (_addeditform.getForm().isValid()) {
        Application.Crm_AssociatPartner.insertProspectData();
      } else {
        Ext.MessageBox.alert("Notification", "Please enter all required fields");
      }
    }; 
          ...
          listeners: {
              rowdeselect: function (sm, rowIndex, record) {
                  ...
                  if (ind == -1) {
                      ...
                      //Application.Crm_AssociatPartner.Cache.isAssigned -= parseInt(record.get('areaBusinessAssociate'));
                  }
              },
  ...
  var upgradeProspectStages = function (id) {
    ...
    var cpfrmProspectWindow = new Ext.Window({
      ...
      items: [
        new Ext.FormPanel({
          layout: "form",
          id:"upgradeProspectStageFormPanel" + Application.Crm_AssociatPartner.Cache.typeName,
          height: 150,
          fileUpload: true,
          columnWidth: 1,
          frame: true,
                  ...
                  buttons: [
                      {
                          ...
                          validator: function (v) {
                              if (v != '')
                              {
                                  ...
                                  if (!(exp.test(v)))
                                  {
                                    Ext.Msg.alert("Notification", "Upload a valid format (png|jpg|gif|pdf|docx).");
                                    return;
                                  }
...
var gridAPOppurtunityDetails = function (typeName) {
    ...
    var gridSelectionChangedaaOppurtunity = function (sm) {
      if (
        !Ext.isEmpty(
          Ext.getCmp(
            "gridAssociatePartnerOppurtunity" + Application.Crm_AssociatPartner.Cache.typeName
          )
            .getSelectionModel()
            .getSelections()
        )
        ...
        var ID = Ext.getCmp(
          ...
          .getSelections()[0].data.aaId;
        Ext.getCmp(
          "tabpanelAssociatePartnerOppurtunity" + Application.Crm_AssociatPartner.Cache.typeName
        ).setActiveTab(0);
        Application.Crm_AssociatPartner.Cache.aaId = ID;
        Application.Crm_AssociatPartner.ViewModeOppurtunity(ID);
      } else {
        Application.Crm_AssociatPartner.Cache.aaId = 0;
        Application.Crm_AssociatPartner.ViewModeOppurtunity(0);
      }
    };
    ...
    var tableOppurtunityDetails = function () {
      ...
      var oppurtunityPanel = new Ext.Panel({
        id: "tableCrmOppurtunityDataview" + Application.Crm_AssociatPartner.Cache.typeName,
        region: "center",
        width: winsize.width * 0.39,
        items: [
          {
        ...
        items: [          
          {
            ...
            handler: function () {
              var aaId = Ext.getCmp("gridAssociatePartnerOppurtunity" + typeName)
                .getSelectionModel()
                .getSelections()[0].data.aaId;
                Application.Crm_AssociatPartner.approveOppurtunity(aaId,typeName);
            }
          },{
    ...
    var gridAPIncubateeDetails = function (typeName) {
        ...
        var gridSelectionChangedaaIncubatee = function (sm) {
          if (
            !Ext.isEmpty(
              Ext.getCmp(
                "gridAssociatePartnerIncubatee" + Application.Crm_AssociatPartner.Cache.typeName
              )
                .getSelectionModel()
                .getSelections()
            )
            ...
            var ID = Ext.getCmp(
              ...
              .getSelections()[0].data.aaId;
            Ext.getCmp(
              "tabpanelAssociatePartnerIncubatee" + Application.Crm_AssociatPartner.Cache.typeName
            ).setActiveTab(0);
            Application.Crm_AssociatPartner.Cache.aaId = ID;
            Application.Crm_AssociatPartner.ViewModeIncubatee(ID);
          } else {

            Application.Crm_AssociatPartner.Cache.aaId = 0;
            Application.Crm_AssociatPartner.ViewModeIncubatee(0);
          }
        };
        ...
        var tableIncubateeDetails = function () {
          ...
          var incubateePanel = new Ext.Panel({
            id: "tableCrmIncubateeDataview" + Application.Crm_AssociatPartner.Cache.typeName,
            region: "center",
            width: winsize.width * 0.39,
            items: [
              {
            ...
            items: [          
              {
                ...
                handler: function () {
                  var aaId = Ext.getCmp("gridAssociatePartnerIncubatee" + typeName)
                    ...
                    Application.Crm_AssociatPartner.trainingUpdates(aaId,aaName);
                }
              }
            ],
          });
        ...
        var upgradeOppurtunityStages = function (id) {
          ...
          var cpfrmOppurtunityWindow = new Ext.Window({
            ...
            items: [
              new Ext.FormPanel({
                layout: "form",
                id:"upgradeOppurtunityStageFormPanel" + Application.Crm_AssociatPartner.Cache.typeName,
                height: 150,
                fileUpload: true,
                columnWidth: 1,
                frame: true,
                            ...
                            listeners: {
                              select: function () {
                                ...
                                if(oppurtunityStage == 12){
                                  Ext.getCmp('areaLockingTime').show();
                                  Ext.getCmp('crmFollowupDate').hide();
                                }else{
                                  Ext.getCmp('crmFollowupDate').show();
                                  Ext.getCmp('areaLockingTime').hide();
                                }
                                if(oppurtunityStage == 13 || oppurtunityStage == 14){
                                  Ext.getCmp('fileuploadfieldAttachFileCustomers').show();
                                }else{
                                  Ext.getCmp('fileuploadfieldAttachFileCustomers').hide();
                                }
            ...
            fbar: [
              ...
              },
              {
                ...
                handler: function () {
                  var crmStatus = Ext.getCmp("crmStatus").getValue();
                  var crmFollowupDate = Ext.getCmp("crmFollowupDate").getValue();
                  var areaLockedTill = Ext.getCmp("areaLockingTime").getValue();
                  var crmRemarks = Ext.getCmp("crmRemarks").getValue();
                  if (crmStatus > 0 && (!Ext.isEmpty(crmFollowupDate) || !Ext.isEmpty(areaLockedTill))) {
                    Ext.Ajax.request({
                      waitMsg: "Processing",
                      method: "POST",
    ...
    var gridAPInstarDetails = function (typeName) {
        ...
        var gridSelectionChangedaaInstar = function (sm) {
          if (
            !Ext.isEmpty(
              Ext.getCmp(
                "gridAssociatePartnerInstar" + Application.Crm_AssociatPartner.Cache.typeName
              )
                .getSelectionModel()
                .getSelections()
            )
            ...
            var ID = Ext.getCmp(
              ...
              .getSelections()[0].data.aaId;
            Ext.getCmp(
              "tabpanelAssociatePartnerInstar" + Application.Crm_AssociatPartner.Cache.typeName
            ).setActiveTab(0);
            Application.Crm_AssociatPartner.Cache.aaId = ID;
            Application.Crm_AssociatPartner.ViewModeInstar(ID);
          } else {
            Application.Crm_AssociatPartner.Cache.aaId = 0;
            Application.Crm_AssociatPartner.ViewModeInstar(0);
          }
        };
        ...
        var tableInstarDetails = function () {
          ...
          var instarPanel = new Ext.Panel({
            id: "tableCrmInstarDataview" + Application.Crm_AssociatPartner.Cache.typeName,
            region: "center",
            width: winsize.width * 0.39,
            items: [
              {
      ...
      Ext.Ajax.request({
          ...
          success: function (response) {
              ...
              if (tmp.success === true) {
                  ...
                  Ext.getCmp('gridAssociatePartnerEnquiry'+Application.Crm_AssociatPartner.Cache.typeName).getStore().reload();
    ...
    return {
      ...
      initAPContacts: function (type) {
        ...
        Application.Crm_AssociatPartner.Cache.type = type;
        Application.Crm_AssociatPartner.Cache.typeName = typeName;
      ...
      ViewModeContact: function () {
        ...
        var apikey = _SESSION.apikey;
        Ext.get(
          "downloadAPContactsIframe" + Application.Crm_AssociatPartner.Cache.typeName
        ).dom.src =
          modURL +
      ...
      insertData: function () {
        ...
        _addContactData.getForm().submit({
          ...
          success: function (form, action) {
            ...
            if (res.success === true) {
              ...
              Ext.getCmp(
                "add_contactWindow" + Application.Crm_AssociatPartner.Cache.typeName
              ).close();
              Ext.getCmp(
                "gridAssociatePartnerContacts" +
                  Application.Crm_AssociatPartner.Cache.typeName
                ...
                .load({
                  callback: function (record, options, success) {
                    if (Application.Crm_AssociatPartner.Cache.upcrocid > 0) {
                      var gridPanel = Ext.getCmp(
                        "gridAssociatePartnerContacts" +
                          Application.Crm_AssociatPartner.Cache.typeName
                      );
                      var index = gridPanel.store.find(
                        "aaId",
                        Application.Crm_AssociatPartner.Cache.upcrocid
                      );
                      gridPanel.getSelectionModel().selectRow(index);
                    }
                  },
        ...
        var apikey = _SESSION.apikey;
        Ext.get(
          "downloadAPEnquiryIframe" + Application.Crm_AssociatPartner.Cache.typeName
        ).dom.src =
          modURL +
          "&op=loadEditData&aaId=" +
          contact_id +
        ...
        var apikey = _SESSION.apikey;
        Ext.get(
          "downloadAPLeadIframe" + Application.Crm_AssociatPartner.Cache.typeName
        ).dom.src =
          modURL +
          "&op=loadEditData&aaId=" +
          contact_id +
        ...
        var apikey = _SESSION.apikey;
        Ext.get(
          "downloadAPProspectIframe" + Application.Crm_AssociatPartner.Cache.typeName
        ).dom.src =
          modURL +
          "&op=loadEditData&aaId=" +
          contact_id +
        ...
        _addProspectData.getForm().submit({
          ...
          success: function (form, action) {
            ...
            if (res.success === true) {
              Application.example.msg("Success", res.msg);
              Ext.getCmp(
                "add_prospectWindow" + Application.Crm_AssociatPartner.Cache.typeName
              ).close();
              Ext.getCmp(
                "gridAssociatePartnerProspect" +
                  Application.Crm_AssociatPartner.Cache.typeName
        ...
        var apikey = _SESSION.apikey;
        Ext.get(
          "downloadAPOppurtunityIframe" + Application.Crm_AssociatPartner.Cache.typeName
        ).dom.src =
          modURL +
          "&op=loadEditData&aaId=" +
          contact_id +
        ...
        var apikey = _SESSION.apikey;
        Ext.get(
          "downloadAPIncubateeIframe" + Application.Crm_AssociatPartner.Cache.typeName
        ).dom.src =
          modURL +
          "&op=loadEditData&aaId=" +
          contact_id +
    ...
    var apikey = _SESSION.apikey;
    Ext.get(
      "downloadAPInstarIframe" + Application.Crm_AssociatPartner.Cache.typeName
    ).dom.src =
      modURL +
      "&op=loadEditData&aaId=" +
      contact_id +
