 ...
 */
    ...
    case 'listApproval':
        ...
        $listQuery = "SELECT acet_NO,acet_DocNO,DATE_FORMAT(acet_Date, '%d-%m-%y') AS acet_Date,IF(acet_Status = 3,1,0) AS Approved,IF(acet_Status = 6,1,IF(acet_Status = 4,1,0)) AS RollBack,
...
*/
        ...
        $acet_NO_safe = $db->sanitizeString($acet_NO);
        $countQuery = "SELECT count(*)
		from " . FINASCOP_DB . "finascop_accounts_transaction
		WHERE acet_NO = '{$acet_NO_safe}'";
		...
		WHERE acet_NO = '{$acet_NO_safe}' {$cond_str}";
