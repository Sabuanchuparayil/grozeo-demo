...
//          it via its parentMenu property.
    ...
    var spGridStore = function () {
        var store = new Ext.data.JsonStore({
            ...
            method: 'post',
            fields: ['br_Name','customerId', 'stpa_Fname', 'stpa_Lname', 'stpa_GSTIN', 'stpa_Address', 'stpa_City', 'stpa_PINCODE', 'st_name', 'dst_Name', 'st_id', 'dst_Id', 'stpa_ContactPerson', 'stpa_MobileNo',
