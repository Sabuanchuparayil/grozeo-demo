...
//                                Application.MyphaAdvertisement.EditAdvertisementView(ID);
    ...
    var advertisementGridstore = function () {
        var _advertisementList = new Ext.data.GroupingStore({
            ...
            reader: new Ext.data.JsonReader({
                ...
                idProperty: 'adv_id',
                root: 'data'
            }, ['adv_id', 'adv_title', 'adzone_name', 'adv_imageurl', 'adv_status', 'adv_usageType','advStatus','advApplicable','advApplicableCategory','advApplicableCategoryName']),
            sortInfo: {
                field: 'adv_id',
                direction: "DESC"
            },
    ...
    var advCategoryStoreFn = function () {
        var categoryStore = new Ext.data.JsonStore({
            url: modURL + '&op=advApplcableCategory',
            method: 'post',
            fields: ['id', 'name'],
            totalProperty: "totalCount",
            root: "data",
    ...
    var advertisementForm = function () {
        ...
        var advCategoryStore = advCategoryStoreFn();
                        ...
                        },
                        {
                                    ...
                                    items: [
                                        {
                                            ...
                                            store: new Ext.data.JsonStore({
                                                ...
                                                select:function(){
                                                    var applicationVal = Ext.getCmp('adv_usageType').getValue();
                                                    Ext.getCmp('ad_id').getStore().load({
                                                        params: {
                                    ...
                                    items: [
                                        {
                                            ...
                                            listeners:{
                                                select: function () {
                                                    var applicationVal = Ext.getCmp('adv_usageType').getValue();
                                                    var themeId = Ext.getCmp('adv_theme').getValue();
                                                    Ext.getCmp('ad_id').getStore().load({
                                                        params: {
                                                            applicationId: applicationVal,
                                                            themeId: themeId
                            ...
                            listeners:{
                                select:function(combo, record, index){
                                    ...
                                    Ext.getCmp('adzoneImageWidth').setValue(adzone_width);
                                    Ext.getCmp('adzoneImageHeight').setValue(adzone_height);
                                }
                            }
                        },{
                            xtype: 'textfield',
                            name: 'adzoneImageWidth',
                            hidden: true,
                            id: 'adzoneImageWidth'
                        },
                        {
                            xtype: 'textfield',
                            name: 'adzoneImageHeight',
                            hidden: true,
                            id: 'adzoneImageHeight'
                        },
                        {
                            layout: 'column',
                            border: false,
...
//                                    enableKeyEvents: true
                                    ...
                                    items: [
                                        {
                                            ...
                                            anchor: '98%',
                                            mode: 'local',
                                            id: 'adv_applicable_for',
                                            name: 'adv_applicable_for',
                                            allowBlank: false,
                                            hiddenName: 'adv_applicable_for',
                                            forceSelection: true,
                                            fieldLabel: 'Applicable For',
                                            emptyText: 'Applicable For',
                                            typeAhead: true,
                                            triggerAction: 'all',
                                            lazyRender: true,
                                            editable: true,
                                            ...
                                            store: new Ext.data.JsonStore({
                                                fields: ['usageid', 'usagetype'],
                                                data: [{usageid: 1, usagetype: 'Grozeo'}, {usageid: 2, usagetype: 'Tenant'}]
                                            })
                                        },
                                    ]
                                }, {
                                    ...
                                    items: [
                                        {
                                            ...
                                            anchor: '98%',
                                            mode: 'local',
                                            id: 'adv_applicable_category',
                                            name: 'adv_applicable_category',
                                            allowBlank: false,
                                            hiddenName: 'adv_applicable_category',
                                            forceSelection: true,
                                            fieldLabel: 'Category',
                                            emptyText: 'Category',
                                            typeAhead: true,
                                            ...
                                            store: new Ext.data.JsonStore({
                                                fields: ['usageid', 'usagetype'],
                                                data: [{usageid: 1, usagetype: 'Business Category'}, {usageid: 2, usagetype: 'Retail Category'}]
                                            }),
                                            listeners: {
                                                select: function () {
                                                    Ext.getCmp('adv_applicable_category_value').getStore().load({
                                                        params: {
                                                            type: Ext.getCmp('adv_applicable_category').getValue()
                                                        }
                                                    });
                                                }
                                            }
                            ...
                            items: [{
                                    ...
                                    items: [{
                                            xtype: 'combo',
                                            fieldLabel: 'Business / Retail Category',
                                            id: 'adv_applicable_category_value',
                                            hiddenName: 'n[adv_applicable_category_value]',
                                            anchor: '98%',
                                            displayField: 'name',
                                            valueField: 'id',
                                            triggerAction: 'all',
    ...
    function addPhoto() {
        ...
        s3.upload({
            ...
            if (!Ext.isEmpty(data.Location)) {
                var img_width = Ext.getCmp('adzoneImageWidth').getValue();
                var img_height = Ext.getCmp('adzoneImageHeight').getValue();
                var img = new Image();
                img.onload = function () {
                    var flag = 1;
    ...
    var advertisementDetailsView = function () {
        return new Ext.Panel({
            ...
            tpl: new Ext.XTemplate('<div class="details-outer">',
                    ...
                    '<tr><th width="40%">Applicable For </th><td>  {advApplicable} </td></tr>',
                    '<tr><th width="40%">Category </th><td>  {advApplicableCategory} </td></tr>',
                    '<tr><th width="40%">Category Name </th><td>  {advApplicableCategoryName} </td></tr>',
                    '<tr><th width="40%">From Date </th><td>  {adv_startdate} </td></tr>',
                    '<tr><th width="40%">To Date </th><td>  {adv_enddate} </td></tr>',
                    '<tr><th width="40%">Status </th><td>  {advStatus} </td></tr>',
        ...
        var _advertisementFilter = new Ext.ux.grid.GridFilters({
            filters: [{
                ...
                },
                {
                    ...
                    type: 'string',
                    dataIndex: 'advApplicable'
                },{
                    type: 'string',
                    dataIndex: 'advApplicableCategory'
                },{
                    type: 'string',
                    dataIndex: 'advApplicableCategoryName'
                },{
                    type: 'string',
                    dataIndex: 'advStatus'
                }
        ...
        var _advPanel = new Ext.grid.GridPanel({
            ...
            columns: [new Ext.grid.RowNumberer(),
                ...
                },
                {
                    ...
                    dataIndex: 'advApplicable',
                    sortable: true,
                    tooltip: 'Applicable For',
                    hideable: true
                },{
                    header: 'Applicable Category',
                    dataIndex: 'advApplicableCategory',
                    sortable: true,
                    tooltip: 'Applicable Category',
                    hideable: true
                },{
                    header: 'Category',
                    dataIndex: 'advApplicableCategoryName',
                    ...
                    handler: function () {
                        ...
                        Ext.Ajax.request({
                            ...
                            params: {
                                ...
                                adv_theme: Ext.getCmp('adv_theme').getValue(),
                                ...
                                adv_applicable_for: Ext.getCmp('adv_applicable_for').getValue(),
                                adv_applicable_category: Ext.getCmp('adv_applicable_category').getValue(),
                                adv_applicable_category_value: Ext.getCmp('adv_applicable_category_value').getValue(),
                            },
                            success: function (response) {
            ...
            if (!Ext.isEmpty(arguments[0])) {
                ...
                masterForm.load({
                    ...
                    success: function (form, action) {
						...
						Ext.getCmp('adv_applicable_category_value').getStore().load({
                                                        params: {
                                                            type: tmp.data.adv_applicable_for
                                                        }
                                                    });
													Ext.getCmp('adv_applicable_category_value').setRawValue(tmp.data.advApplicableCategoryName);
                    },
            ...
            if (!Ext.isEmpty(arguments[0])) {
                ...
                hnsForm.load({
                    ...
                    success: function (form, action) {
                        ...
                        Ext.getCmp('ad_id').setValue(tmp.data.ad_id);
                        Ext.getCmp('ad_id').getStore().load({
                            params: {
                                applicationId: tmp.data.adv_usageType,
                                themeId: tmp.data.adv_theme
                            }
                        });
                        ...
                        Ext.getCmp('adv_applicable_category_value').getStore().load({
                            params: {
                                type: tmp.data.adv_applicable_category
                            }
                        });
						Ext.getCmp('adv_applicable_category_value').setRawValue(tmp.data.advApplicableCategoryName);
