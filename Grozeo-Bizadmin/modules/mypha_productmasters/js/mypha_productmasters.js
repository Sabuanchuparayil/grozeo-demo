    ...
    var _subCatGridFilter = new Ext.ux.grid.GridFilters({
      filters: [
        ...
        },
        {
          ...
          options: ["Yes", "No"],
          phpMode: true,
          dataIndex: "sbc_isCompositionDelator",
        }, {
          type: "list",
          options: ["Yes", "No"],
          phpMode: true,
          dataIndex: "sbc_isNonGstRetailer",
        }, {
          type: "list",
          options: ["Yes", "No"],
          phpMode: true,
          dataIndex: "sbc_isPerishable",
        }, {
          type: "list",
          options: ["Yes", "No"],
          phpMode: true,
          dataIndex: "sbc_hasRestaurantService",
        },{
          type: "list",
          options: ["Yes", "No"],
          phpMode: true,
          dataIndex: "sbc_isProductDetail",
        },
        {
          type: "list",
          options: ["Active", "Inactive"],
    ...
    var _gridPanel = new Ext.grid.GridPanel({
      ...
      columns: [
        ...
        },
        {
          ...
          header: "Composition Delater",
          sortable: true,
          hideable: true,
          dataIndex: "sbc_isCompositionDelator",
          tooltip: "Composition Delater",
        },{
          header: "Non GST Retailer",
          sortable: true,
          hideable: true,
          dataIndex: "sbc_isNonGstRetailer",
          tooltip: "Non GST Retailer",
        },{
          header: "Perishable",
          sortable: true,
          hideable: true,
    ...
    var _store = new Ext.data.GroupingStore({
      ...
      reader: new Ext.data.JsonReader(
        ...
        [
          "sub_cat",
          "sub_category_id",
          "business_type_name","parent_category","category_name",
          "isHome",
          "isInCategory",
          "hasImage",
          "substatus","sbc_isCompositionDelator","sbc_isNonGstRetailer","sbc_isPerishable","sbc_hasRestaurantService","sbc_isProductDetail","processingTime"
        ]
      ),
      sortInfo: {
            ...
            /*<?php if (user_access("mypha_productmasters", "saveHSN")) { ?> */ {
              ...
              handler: function () {
                var ID = Ext.getCmp("gridpanelMasterDataviewHsndata")
                  .getSelectionModel()
                  .getSelections()[0].data.hsn_id;
                  var hsn_id_pk = Ext.getCmp("gridpanelMasterDataviewHsndata")
                  .getSelectionModel()
                  .getSelections()[0].data.hsn_id_pk;
                Application.MyphaProductmasters.EditHSNView(ID,hsn_id_pk);
              },
            },
            {
              text: "Save",
