...
if ($order_id > 0) {
    ...
    $data = $db->getFromDB(" SELECT order_id ,order_order_id, order_group_id,order_total_amount,order_delivery_charge,order_customer_id, payment_mode,order_courier_charge,
    ...
    $deliveryDetails = $db->getFromDB("SELECT order_pin,order_house_no,order_house_name,order_land_mark,order_city FROM retaline_customer_order_delivery_address WHERE customer_order_id = {$order_id}", true);
                ...
                <tr>
                    ...
                    <td>
                        <b> <?php echo $deliveryDetails['order_house_no']; ?>  <?php echo $deliveryDetails['order_house_name']; ?> </br>
                            <?php echo $deliveryDetails['order_land_mark']; ?>  <?php echo $deliveryDetails['order_city']; ?> - <?php echo $deliveryDetails['order_pin']; ?>
                        </b>
                    </td>
                </tr>
            </tbody>
        ...
        <table width="100%" cellspacing="2" cellpadding="2" border="0" class="cesstable">
            <tbody><tr>
                ...
                foreach ($pdts as $key2 => $value2) {
                    ...
                    . "<td style='text-align: right;padding-right: 10px;'>{$value2['item_price']}</td>"
                    . " <td style='text-align: right;padding-right: 10px;'>{$value2['item_sales_price']}</td>"
                    . "</tr> ";
                }
                ...
                <tr>
                    ...
                    <td width="25%" style='text-align: right;padding-right: 10px;'><strong><?php echo $price_sum ?></strong></td>
                    <td width="25%" style='text-align: right;padding-right: 10px;'><strong><?php echo $data['total'] ?></strong></td>
