...
switch ($op) {
    ...
    } else if ($val['field'] == 'order_user_type') {
                            $fiterItem = $val['data']['value'];
                            $fiterItem = str_replace(',', "','", $fiterItem);
                            $filter_qry .= " AND order_user_type IN ('" . $fiterItem . "')";
                        } else if ($val['field'] == 'order_status') {
                            $fiterItem = $val['data']['value'];
                            $fiterItem = str_replace(',', "','", $fiterItem);
                            $filter_qry .= " AND order_status_config_name IN ('" . $fiterItem . "')";
                        }
                }
            }
        }
