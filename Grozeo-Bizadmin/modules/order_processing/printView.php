...
if ($order_auto_id > 0) {
    ...
    $data = $db->getFromDB(" SELECT order_id ,order_order_id, cust_customer_name,order_total_amount,order_delivery_charge, 
            ...
            <ul class="order">
                ...
                <li><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        if (!empty($pdts)) {
                            $i = 1;
                            $total_qty = 0;
                            foreach ($pdts as $product_data) {

                                $total_qty +=$product_data['item_order_qty'];

                                echo "
                  <tr>
                  <td>" . $i++ . "</td>
                   <td>" . $product_data['product_name'] . "</td>
                   <td>" . $product_data['item_order_qty'] . "</td>
                </tr>";
                            }
                            ?>
                        </table>
