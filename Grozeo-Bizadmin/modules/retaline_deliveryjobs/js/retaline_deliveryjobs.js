...
//            if (quor_TransferOrder_Type == 0) {
//                Ext.getCmp('djPrintInvoice').show();
//                Ext.getCmp('djPrintDeliveryNote').show();
//            } else {
//                Ext.getCmp('djPrintInvoice').hide();
//                Ext.getCmp('djPrintDeliveryNote').hide();
//            }
        ...
        return new Ext.menu.Menu({
            items: [{
                    ...
                    handler: function () {
                        ...
                        var quor_Type = record.data.quor_Type;
                        var quor_Status = record.data.quor_Status;
                        var quor_Paymode = record.data.quor_Paymode;
                        var quor_AmountCollectible = record.data.quor_AmountCollectible;
                        Application.DeliveryJobs.orderCustomerPickUp(quor_id, quor_Type, quor_Status,quor_Paymode,quor_AmountCollectible);
                    }
                }, {
                    text: "Driver Pickup",
                    id: "djDriverPickUp",
            ...
            items: [deliveryJobsGrid(ind),
                new Ext.Panel({
                    ...
                    fbar: [{
                            ...
                            hidden: true,
                            handler: function () {
                                var quor_id = Ext.getCmp('schedule_grid_dj').getSelectionModel().getSelections()[0].data.quor_id;
...
//            height: winsize.height * 0.3,
    ...
    return {
        ...
        viewPolledHistory: function (quor_id) {
            var _polledItemsWindow = new Ext.Window({
                ...
                fbar: [{
                    ...
                    handler: function () {
                        Ext.Ajax.request({
                            url: modURL + "&op=resetDrive",
                            method: "POST",
                            params: { quor_id: quor_id },
                            success: function (res) {
                              var tmp = Ext.decode(res.responseText);
                              if (tmp.success === true) {
                                Application.example.msg('Success', tmp.msg);
        ...
        orderCustomerPickUp: function (quor_id, quor_Type, quor_Status,quor_Paymode,quor_AmountCollectible) {

            var _custPickupForm = customerPickupForm(quor_Paymode,quor_AmountCollectible);
