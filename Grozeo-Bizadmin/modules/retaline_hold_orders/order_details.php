...
if ($order_id > 0) {
    ...
    $data = $db->getFromDB(" SELECT order_id ,order_order_id, order_total_amount,order_cess,order_delivery_charge,order_customer_id, payment_mode,order_courier_charge,
            admin_description as order_status,order_total_gst,DATE_FORMAT(order_confirm_date,'%d-%m-%Y') as order_confirm_date,total,order_app_version,order_app_os,TIME_FORMAT(cast(order_confirm_date as time),'%r') as ordertime "
...
//                    . "<td style='text-align: right;padding-right: 10px;'>{$value2['item_amount']}</td>"
                ...
                <tr>
                    ...
                    <td width="25%"><strong><?php echo '-' ?></strong></td>
                    <td width="25%"><strong><?php echo '-' ?></strong></td>
                    <td width="25%"><strong><?php echo $data['order_cess']; ?></strong></td>
                </tr>
                <tr>
