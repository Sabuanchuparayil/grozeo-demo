        ...
        addTimeRangeForBranch: function (id, name, picodes) {
            ...
            if (Ext.isEmpty(addTimeRangeToPincodeGroupWindow)) {
                addTimeRangeToPincodeGroupWindow = new Ext.Window({
                    ...
                    title: 'Scheduled Time Range for Store',
                    layout: 'border',
                    bodyStyle: {"background-color": "white", "padding": "5px 5px 5px 10px"},
                    width: 1000,
                    height: 600,
                    ...
                    bbar: [{html: '&nbsp;Packing before : &nbsp;'}, {
                            xtype: 'numberfield',
                            fieldLabel: 'Packing before',
                            id: 'br_schedulePackiing',
                            name: 'br_schedulePackiing',
                            value: name,
                            anchor: '98%',
                            allowBlank: false,
                            width: 50,
                            ...
                            handler: function () {
                                ...
                                var t_stamp = t.format("YmdHis");
                                //var slotForm = Ext.getCmp('timeRangePincodeGroupMasterForm').getForm();
                                if (!Ext.isEmpty(Ext.getCmp('br_schedulePackiing').getValue())) {
                                    Ext.Ajax.request({
                                        url: modURL + '&op=updateSchedulePacking',
                                        method: 'POST',
                                        params: {
                                            branch_id: id,
                                            br_schedulePackiing: Ext.getCmp('br_schedulePackiing').getValue()
                                        },
                                        success: function (response) {
