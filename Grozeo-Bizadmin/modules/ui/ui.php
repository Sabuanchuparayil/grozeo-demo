...
<HTML>
    <HEAD>
        ...
        <link rel="shortcut icon" href="./resources/custom_files/favicon.ico" type="image/png" />
...
<!--<script src="https://maps.googleapis.com/maps/api/js?key=" . GOOGLE_MAP_API_KEY . "&sensor=false"> </script>--> 
        ...
        <script src="https://maps.googleapis.com/maps/api/js?&libraries=places&key=<?= GOOGLE_MAP_API_KEY; ?>"></script>
    ...
    <BODY scroll="no" bgcolor="silver" rightmargin="0" leftmargin="0" topmargin="0" bottommargin="0">
        ...
        <div id="topheader" class="headermainlogo" style="max-height:60px;">
            ...
            <div id="headerlogo" class="headerlogoleft" style="max-height:60px;"><img src="./resources/custom_files/admin-logo.png"  alt="Admin logo"  height="60"/> 
                ...
                if (isset($_SESSION['admin']->IsApplicationLogin)) {
                    ...
                    <a href="#" id="profile_menu" onBlur="hideProfileMenu();" onClick="showProfileMenu();
                           ...
                           if (!empty($_SESSION['admin']->finascop_current_branch_id)) {
                               $branchName = $db->getItemFromDB("SELECT CONCAT(br_Name ,'-',branch_shortname) from finascop_branch where br_ID = {$_SESSION['admin']->finascop_current_branch_id}");
                           }
