	...
	namespace Models;
	{
		class Utils 
		{
			...
			public function getOTP($mobile){	
				$mobiles = ["9061160000", "9846583711", "8289847144", "9895670756", "8129160154","9495050000","9995445945"];
				$db = new \cgoSqlDB();	
				
				$ver = $db->getFromDB('select COUNT(1) AS ismobile,mobile,otp FROM test_mobile  WHERE mobile = ?',array('s',$mobile) ,true);
