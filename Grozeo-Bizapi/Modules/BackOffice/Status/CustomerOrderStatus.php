...
final class CustomerOrderStatus
{
    ...
    public const PACKED_NOT_BOXED=51;
    ...
    public const CANCELLED_AFTER_PACKING = 24;
    public const NOT_DELIVERABLE = 54;

    public const DELIVERED_NOT_CONFIRMED = 17;
    public const DELIVERED = 18;
    public const PICKUP_CONSIGNMENT = 20;
    public const DELIVERY_ASSIGNED = 14;
    public const OUT_FOR_DELIVERY = 15;
    public const DELIVERY_FAILED = 16;
