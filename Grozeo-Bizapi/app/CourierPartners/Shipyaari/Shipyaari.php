...
class Shipyaari
{
	...
	public function getPartnersList($data)
	{
		...
		$partnerDetails = $this->checkForPartners($details);
		...
		{
			$partner = $partnerDetails->selected;
			return [
				"status"	=> "success",
				...
				'selected'	=> json_encode(@$partner),
				'response'	=> json_encode(@$partnerDetails->response)
			];
		}
	}
	...
	public function createConsignment($fsto_id)
	{
		try
		{
