...
class AesForJava {
     ...
     * @throws Exception
     */
    public function encrypt($data = null, $key = null, $blockSize = null, $mode = null, $iv = null) {
		if(extension_loaded('openssl'))
		{
			...
			if ($mode == 'cbc') {
				return $result = base64_encode(openssl_encrypt($data, 'AES-128-CBC', $key, OPENSSL_RAW_DATA, $iv));
			}
     ...
     * @throws Exception
     */
    public function decrypt($data = null, $key = null, $blockSize = null, $mode = null, $iv = null) {
	if(extension_loaded('openssl'))
		{
			if (is_array($iv)) 
                                $iv = implode(array_map("chr", $iv));
			...
			if ($mode == 'cbc') {
                                return $result = openssl_decrypt($data, 'AES-128-CBC', $key, OPENSSL_PKCS1_OAEP_PADDING, $iv);
                        }
