                ...
                if($productData)
                {
                    ...
                    if(@$orderData->order_branch_id > 0)
                    {
                        ...
                        if(empty($shipmentExists))
                        {
                            ...
                            {
                                $length = (@$oitem->item->item_length > 0) ? $oitem->item->item_length : 10;
                                $height = (@$oitem->item->item_height > 0) ? $oitem->item->item_height : 10;
                                $depth = (@$oitem->item->item_breadth > 0) ? $oitem->item->item_breadth : 10;
