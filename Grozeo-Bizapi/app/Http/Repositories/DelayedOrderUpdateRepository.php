...
class DelayedOrderUpdateRepository
{
    ...
    private function packingNotStarted($orderID)
    {
        ...
        if($order)
        {
            ...
            'Item'      => [
                ...
                'storeGroupID'      => ['N' => (string)$order->branchDetails->br_storeGroup],
    ...
    private function getDelayTableData($orderID, $type)
    {
        $params = [
            'TableName'                 => config('aws.prefix').'delayed_orders',
            'FilterExpression'          => 'orderID = :orderID AND #typeAttr < :typeValue',
