<%@ Page Language="C#" MasterPageFile="~/Business/BusinessMaster.master" Title="Create Lead" Async="true" AutoEventWireup="true" CodeBehind="AsstLeadSettings.aspx.cs" Inherits="RetalineProAgent.AsstLeadSettings" %>
...
<asp:Content ContentPlaceHolderID="cpNBreadcrumb" runat="server">
    ...
    <li class="breadcrumb-item"><a href="/Business/ClientManagement?type=lead">Leads</a></li>
    ...
    <div class="section-wrapper">
          ...
          <div class="form-layout">
            <div class="row mg-b-5">
              <div class="col-lg-4">
                ...
                <div class="form-group">
                  ...
                  <asp:ListBox ID="lstContactType" Visible="true"  SelectionMode="Multiple" OnDataBound="lstContactType_DataBound" runat="server" DataSourceID="SDSContactType" DataTextField="name" DataValueField="id"
                          CssClass="form-control select2" multiple="multiple"></asp:ListBox>
                    <asp:TextBox runat="server" Visible="false" CssClass="form-control" ID="txtleadtype"></asp:TextBox>
                ...
                SelectCommand="SELECT id,name FROM crm_contact_type WHERE status = 1 AND id IN (1,3)"></asp:SqlDataSource>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group input-group loadmapbox" style="overflow:hidden;"><asp:HiddenField ID="hidMapAddr" runat="server" /> 
            ...
            <div class="form-layout-footer">
                <asp:HiddenField  runat="server" ID="hdfareaid"/>
                <asp:HiddenField runat="server" ID="hdfareaname" />
            ...
            <a href="/Business/ClientManagement?type=lead" class="btn btn-secondary">Cancel</a>
            </div>
              </div>
          </div><!-- form-layout -->
   ...
   <script type="text/javascript">
       $(function () {
           ...
           $('#modaldemo4').on('hidden.bs.modal', function (e) {
               window.location.href = "/Business/ClientManagement?type=lead";
           });
       });
