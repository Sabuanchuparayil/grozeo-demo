<%@ Page Language="C#" MasterPageFile="~/Business/BusinessMaster.master" Title="Create Contact" Async="true" AutoEventWireup="true" CodeBehind="ContactSettings.aspx.cs" Inherits="RetalineProAgent.ContactSettings" %>
...
<asp:Content ContentPlaceHolderID="cpNTitle" runat="server" ID="cTitle">
    <h6 class="slim-pagetitle"><%= (String.IsNullOrEmpty(Request.QueryString["id"]) ? "Create New Contact" : "Edit Contact") %></h6>
</asp:Content>

<asp:Content ContentPlaceHolderID="cpNBreadcrumb" runat="server">
    <li class="breadcrumb-item"><a href="/">Home</a></li>
    <li class="breadcrumb-item"><a href="/Business/BusinessNavigations/BusinessCRM">CRM</a></li>
    <li class="breadcrumb-item"><a href="/Business/ClientManagement?type=contact">Contacts</a></li>
          ...
          <div class="form-layout">
            <div class="row mg-b-5">
              <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Contact Type: <span class="tx-danger">*</span></label>
                ...
                SelectCommand="SELECT id,name FROM crm_contact_type WHERE status = 1 AND isMerchant = 1"></asp:SqlDataSource>
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="lstContactType" CssClass="error_msg_wrap" Display="Dynamic" ErrorMessage="Contact type is required" ValidationGroup="InsertContact" ForeColor="Red"></asp:RequiredFieldValidator>
                </div>
              </div><!-- col-4 -->
                <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <div class="input-group input-group loadmapbox"><asp:HiddenField ID="hidMapAddr" runat="server" /> 
			      <asp:TextBox ID="txtLocation" runat="server" ReadOnly="true" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#ADDRESS" required CssClass="form-control rounded-0 border-0" placeholder="Click to load map" autocomplete="off"/>                  
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Location: <span class="tx-danger">*</span></label>
                    <input type="text" style="display:none" />
                    <input type="password" style="display:none" />
                  <asp:TextBox ID="txtAddr1" runat="server"  CssClass="form-control" placeholder="Enter Store Location" autocomplete="off"/>
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="txtAddr1" CssClass="error_msg_wrap" Display="Dynamic" ErrorMessage="Location is required" ValidationGroup="InsertContact" ForeColor="Red"></asp:RequiredFieldValidator>
                </div>
              </div><!-- col-4 -->
                <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <asp:TextBox ID="txtAddr2" runat="server" CssClass="form-control" placeholder="Enter Store Address" autocomplete="off"/>
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="txtAddr2" CssClass="error_msg_wrap" Display="Dynamic" ErrorMessage="Store address is required" ValidationGroup="InsertContact" ForeColor="Red"></asp:RequiredFieldValidator>
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Pin Code: <span class="tx-danger">*</span></label>
                   ...
                   <asp:TextBox ID="txtPinCode" runat="server" CssClass="form-control" placeholder="Enter Pin Code" autocomplete="off"/>
                    <asp:RequiredFieldValidator ID="rqdpincod" runat="server" ControlToValidate="txtPinCode" CssClass="error_msg_wrap" Display="Dynamic" ErrorMessage="Pin code is required" ValidationGroup="InsertContact" ForeColor="Red"></asp:RequiredFieldValidator>
                </div>
              </div><!-- col-4 -->
              <%--<div class="col-lg-8">
                <div class="form-group">
              ...
              <div class="col-lg-4">
                ...
                <div class="form-group">
                  ...
                  <asp:DropDownList ID="selRetailCategory" runat="server" AutoPostBack="false" CssClass="form-control select2" ForeColor="GrayText" DataSourceID="SDSRetailCat" DataTextField="business_type_name" AppendDataBoundItems="true" DataValueField="business_type_id"><asp:ListItem Text="Select retail category" Value=""></asp:ListItem></asp:DropDownList>
                ...
                SELECT 0 AS business_type_id,'Others' AS business_type_name FROM finascop_business_type"></asp:SqlDataSource>
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="selRetailCategory" CssClass="error_msg_wrap" Display="Dynamic" ErrorMessage="Retail category is required" ValidationGroup="InsertContact" ForeColor="Red"></asp:RequiredFieldValidator>
                </div>
              </div><!-- col-4 -->--%>
                <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Business Type: <span class="tx-danger">*</span></label>
                  <asp:DropDownList ID="selBusinessCat" runat="server" AutoPostBack="true" CssClass="form-control select2" ForeColor="GrayText" DataSourceID="SDSBusinessCat" DataTextField="business_category_name" AppendDataBoundItems="true" DataValueField="business_category_id">
                      <asp:ListItem Value="0" Text="Select business type"></asp:ListItem></asp:DropDownList>
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="selBusinessCat" CssClass="error_msg_wrap" Display="Dynamic" ErrorMessage="Select business type" ValidationGroup="InsertContact" ForeColor="Red"></asp:RequiredFieldValidator>
                    <asp:SqlDataSource runat="server" ID="SDSBusinessCat" ProviderName="MySql.Data.MySqlClient" ConnectionString="<%$ ConnectionStrings:mySqlConnection %>"
                    SelectCommand="SELECT business_category_id,business_category_name FROM retaline_business_category 
                    WHERE business_category_ingroup=1 AND store_group_id=0 AND STATUS = 1 UNION 
                    SELECT -1 AS business_category_id,'Others' AS business_category_name FROM retaline_business_category "></asp:SqlDataSource>
                    
                </div>
              </div><!-- col-4 -->
                
                <div class="col-lg-4" runat="server" id="otherBusinessCat" visible="false">
                <div class="form-group">
                  <label class="form-control-label">Other Type: <span class="tx-danger">*</span></label>
                  <asp:DropDownList ID="selBusinessCategory" runat="server" AutoPostBack="false" CssClass="form-control select2" ForeColor="GrayText" DataSourceID="SDSBusinessCaytegory" DataTextField="business_category_name" AppendDataBoundItems="true" DataValueField="business_category_id">
                      <asp:ListItem Text="Select other type" Value=""></asp:ListItem></asp:DropDownList>
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="selBusinessCategory" CssClass="error_msg_wrap" Display="Dynamic" ErrorMessage="Select other type" ValidationGroup="InsertContact" ForeColor="Red"></asp:RequiredFieldValidator>
                    <asp:SqlDataSource runat="server" ID="SDSBusinessCaytegory" ProviderName="MySql.Data.MySqlClient" ConnectionString="<%$ ConnectionStrings:mySqlConnection %>"
                    SelectCommand="SELECT business_category_id,business_category_name FROM retaline_business_category WHERE STATUS = 1 AND business_category_ingroup=0"></asp:SqlDataSource>
                </div>
              </div><!-- col-4 -->
                <div class="col-lg-4">
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" style="display:none" />
                  <input type="password" style="display:none" />
                  <asp:TextBox ID="txtRemarks" runat="server" autocomplete="off" TextMode="MultiLine" CssClass="form-control" placeholder="Enter remarks" />
                    <%--<asp:RequiredFieldValidator runat="server" ControlToValidate="txtRemarks" CssClass="error_msg_wrap" Display="Dynamic" ErrorMessage="Email is required" ValidationGroup="InsertContact" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                </div>
              </div>
            </div><!-- row -->
            ...
            <a href="/Business/ClientManagement?type=contact" class="btn btn-secondary">Cancel</a>
            </div>
              </div>
          </div><!-- form-layout -->
