<%@ Page Language="C#" AutoEventWireup="true" Async="true" Title="Delivery Booking Failed" MasterPageFile="~/Business/BusinessMaster.master" CodeBehind="DeliveryBookingFailed.aspx.cs" Inherits="RetalineProAgent.Business.DeliveryBookingFailed" %>
                        ...
                        <div class="collapse navbar-collapse flex-wrap" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto pt-2 pt-lg-0">
                                ...
                                <li class="nav-item mx-0 mx-lg-1 my-1 my-lg-0">
                                    <asp:LinkButton ID="lbtnAPIBookingFailed" runat="server" OnClick="btnFilterType_Click" CommandArgument="6" CssClass="btn btn-block btn-outline-primary" OnClientClick="setActiveClass(this);">API Booking Failed</asp:LinkButton>
                                </li>
                                <li class="nav-item mx-0 mx-lg-1 my-1 my-lg-0">
                                    <asp:LinkButton ID="lbtnHyperlocalPending" runat="server" OnClick="btnFilterType_Click" CommandArgument="2" CssClass="btn btn-block btn-outline-primary" OnClientClick="setActiveClass(this);">Hyperlocal Pending</asp:LinkButton>
                                </li>
                                <li class="nav-item mx-0 mx-lg-1 my-1 my-lg-0">
                                    <asp:LinkButton ID="lbtnLocalExpressPending" runat="server" OnClick="btnFilterType_Click" CommandArgument="3" CssClass="btn btn-block btn-outline-primary" OnClientClick="setActiveClass(this);">Local Express Pending</asp:LinkButton>
                                </li>
                                <li class="nav-item mx-0 mx-lg-1 my-1 my-lg-0">
                                    <asp:LinkButton ID="lbtnCourierPickupDelayed" runat="server" OnClick="btnFilterType_Click" CommandArgument="1" CssClass="btn btn-block btn-outline-primary" OnClientClick="setActiveClass(this);">Courier Pickup Delayed</asp:LinkButton>
                                </li>
                                <li class="nav-item mx-0 mx-lg-1 my-1 my-lg-0">
                                    <asp:LinkButton ID="lbtnParcelBooking" runat="server" OnClick="btnFilterType_Click" CommandArgument="4" CssClass="btn btn-block btn-outline-primary" OnClientClick="setActiveClass(this);">Parcel Booking</asp:LinkButton>
                                </li>
                                <li class="nav-item mx-0 mx-lg-1 my-1 my-lg-0">
                                    <asp:LinkButton ID="lbtnCargoBooking" runat="server" OnClick="btnFilterType_Click" CommandArgument="5" CssClass="btn btn-block btn-outline-primary" OnClientClick="setActiveClass(this);">Cargo Booking</asp:LinkButton>
                                </li>
                            </ul>
                        </div>
