...
{
    public partial class RLeadSettings: Base.BasePartnerPage
    {
        ...
        protected async void btnContactSubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    fcparams.Add(new KeyValuePair<string, object>("contactType", 1));
                    ...
                    if (rleadId <= 0)
                    {
                        ...
                        ShowSuccess("Success!", "Contact created successfully!!", "/Business/RetailerLeads");
                    }
                    else
                    {
                        ...
                        ShowSuccess("Success", "Contact updated successfully!!", "/Business/RetailerLeads");
                    }
                }
                catch
                {
