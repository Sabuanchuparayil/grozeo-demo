<%@ Page Language="C#" MasterPageFile="~/Business/BusinessMaster.master" Title="Create Wholesaler Lead" Async="true" AutoEventWireup="true" CodeBehind="WLeadSettings.aspx.cs" Inherits="RetalineProAgent.WLeadSettings" %>
...
<asp:Content ContentPlaceHolderID="cpNTitle" runat="server" ID="cTitle">
    <h6 class="slim-pagetitle"><%= (String.IsNullOrEmpty(Request.QueryString["id"]) ? "Create New Wholesaler Leads" : "Edit Wholesaler Leads") %></h6>
</asp:Content>

<asp:Content ContentPlaceHolderID="cpNBreadcrumb" runat="server">
    <li class="breadcrumb-item"><a href="/">Home</a></li>
    <li class="breadcrumb-item"><a href="/Business/BusinessNavigations/BusinessCRM">CRM</a></li>
    <li class="breadcrumb-item"><a href="/Business/WholesalerLeads">Wholesaler Leads</a></li>
    <li class="breadcrumb-item active" aria-current="page">Create Wholesaler Leads</li>
</asp:Content>
...
<asp:Content runat="server" ContentPlaceHolderID="cpNMainContent">
    <div class="section-wrapper">
          ...
          <div class="form-layout">
            ...
            <a href="/Business/WholesalerLeads" class="btn btn-secondary bd-0" style="height:45px; width:100px">Cancel</a>
            </div>
              </div>
          </div><!-- form-layout -->
