...
{
    public partial class WholesalerLeads: Base.BasePartnerPage
    {
        ...
        protected void gvWholesalerLeads_DataBound(object sender, EventArgs e)
        {

        }

        protected void SDSWholesalerLeads_Selecting(object sender, SqlDataSourceSelectingEventArgs e)
        {
