<%@ Page Language="C#" MasterPageFile="~/AgentMaster.Master" Title="" AutoEventWireup="true" CodeBehind="Communication.aspx.cs" Inherits="RetalineProAgent.Communication" %>

<asp:Content ContentPlaceHolderID="head" runat="server">

    <script src="/Content/lib/bootstrap-switch/js/bootstrap-switch.min.js"></script>
      <link rel="stylesheet" href="/Content/lib/icheck-bootstrap/icheck-bootstrap.min.css">
</asp:Content>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <%--<div class="col-3"><label>Branch</label>
                    <asp:DropDownList ID="selBranches" AutoPostBack="true" style="float: left; width: 50%" DataSourceID="SDSBranches" AppendDataBoundItems="true" DataTextField="br_Name"  DataValueField="br_ID" CssClass="form-control" runat="server"><asp:ListItem Text="Select Branch" Value=""></asp:ListItem></asp:DropDownList>
