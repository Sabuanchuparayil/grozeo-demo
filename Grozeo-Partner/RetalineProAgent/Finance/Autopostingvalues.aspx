<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Autopostingvalues.aspx.cs" MasterPageFile="~/Finance/FinanceMaster.master" Inherits="RetalineProAgent.Finance.Autopostingvalues" %>
     ...
     <div class="row">
        <div class="col-12">
            ...
            <div class="col-12">
                ...
                <asp:GridView AutoGenerateColumns="false" ID="gvatopostingentries"  runat="server" CssClass="table table-bordered gridview_table" BorderStyle="Solid" 
                    DataSourceID="SDSauopostingvalue" AllowPaging="true" PagerStyle-CssClass="pg_table" PageSize="10" DataKeyNames="Id">
                    <Columns>
                ...
                <asp:SqlDataSource runat="server" ID="SDSauopostingvalue" ProviderName="MySql.Data.MySqlClient"  ConnectionString="<%$ ConnectionStrings:mySqlConnection %>"
                    SelectCommand="SELECT fc.id,rc.order_order_id,fc.order_id,rc.order_confirm_date,total,br_storeGroup,rc.order_confirmed_on,
                                    ...
                                    WHERE  status_id>4 AND (@fromDate IS NULL OR @fromDate = '' OR CAST(rc.order_confirmed_on AS DATE) >= CAST(@fromDate AS DATE)) AND
                                     ...
                                     AND (TRIM(@search) = '' OR rc.order_order_id LIKE CONCAT('%', @search, '%') OR (SELECT store_group_name FROM finascop_branch_group fbg WHERE fbg.store_group_id = fb.br_storeGroup 
                                    LIMIT 1) LIKE CONCAT('%', @search, '%') OR total LIKE CONCAT('%', @search, '%') OR fc.id LIKE CONCAT('%', @search, '%'))
                                     GROUP BY order_id ORDER BY rc.order_order_id DESC ">
                    <SelectParameters>    
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-4 d-flex align-items-center ">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <asp:SqlDataSource ID="SDSrulename" runat="server" SelectCommand="SELECT id,rulename  FROM `finance_autoposting_rule` WHERE STATUS=1 ORDER BY id" ProviderName="MySql.Data.MySqlClient" ConnectionString="<%$ ConnectionStrings:mySqlConnection %>"></asp:SqlDataSource>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-3">
                           ...
                           <asp:ObjectDataSource runat="server" ID="ODSordervaluehead" TypeName="RetalineProAgent.Finance.Autopostingvalues" SelectMethod="LoadOrderValueHeads" >
                               <SelectParameters>
                                        ...
                                        <asp:ListView ID="lvDataEny" runat="server" DataSourceID="ODSordervaluehead" OnDataBound="lvDataEny_DataBound">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <tr class="TableData">
                                                    ...
                                                    <td align="right">
                                                        <asp:Label ID="lbdrname" CssClass="drval" Visible="false" runat="server" Text='<%# !String.IsNullOrEmpty(Eval("splitdrvalue").ToString()) ? Convert.ToDouble(Eval("splitdrvalue")).ToString("0.00"):"" %>' ></asp:Label>
                                                    </td>
                                                    <td align="right">
                                                        <asp:Label ID="lbcrname" CssClass="crval" runat="server" Visible="false" Text='<%# !String.IsNullOrEmpty(Eval("splitcrvalue").ToString()) ? Convert.ToDouble(Eval("splitcrvalue")).ToString("0.00"):"" %>' ></asp:Label>
                                                    </td>
                                                    <td align="center">
