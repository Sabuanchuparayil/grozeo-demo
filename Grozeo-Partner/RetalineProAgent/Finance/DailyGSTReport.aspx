<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyGSTReport.aspx.cs" MasterPageFile="~/Finance/FinanceMaster.master" Inherits="RetalineProAgent.Finance.DailyGSTReport" %>
...
<asp:Content ContentPlaceHolderID="cpNTitle" runat="server">
    <h6 class="slim-pagetitle">Daily GST Report</h6>
    <p class="mb-0">Daily GST Report</p>
</asp:Content>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                SelectCommand="SELECT COUNT(order_invoiceno) AS invoicecount,order_invoicedate,MerchantSalesTotal_ForSettlement,
                                    SUM( MerchantSalesIGSTTotal_ForSettlement) AS MerchantSalesIGSTTotal_ForSettlement,SUM(MerchantSalesCGSTTotal_ForSettlement) AS MerchantSalesCGSTTotal_ForSettlement,
                                    SUM((MerchantSalesSGSTTotal_ForSettlement)) AS MerchantSalesSGSTTotal_ForSettlement,
                                    SUM(MerchantSalesUTGSTTotal_ForSettlement) AS MerchantSalesUTGSTTotal_ForSettlement,SUM(MerchantSalesCCTotal_ForSettlement) AS MerchantSalesCCTotal_ForSettlement,SUM((MerchantSalesIGSTTotal_ForSettlement+MerchantSalesCGSTTotal_ForSettlement+
                                    ...
                                    (MerchantSalesSGSTTotal_ForSettlement)+(MerchantSalesUTGSTTotal_ForSettlement)+
                                    (MerchantSalesCCTotal_ForSettlement) +SUM(MerchantSalesTotal_ForSettlement)) AS invoicetotal FROM  finance_autoposting_values fa
                                   ...
                                   OR ( @datefilter = 4 AND DATE_FORMAT(order_invoicedate, '%Y') = DATE_FORMAT(CURDATE(), '%Y')) GROUP BY order_invoicedate">
        <SelectParameters>           
