<%@ Page Language="C#" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" Title="GST Report" CodeBehind="GST_on_Sales95_Detailed.aspx.cs"
    MasterPageFile="~/Finance/FinanceMaster.master" Inherits="RetalineProAgent.Finance.GST_on_Sales95_Detailed" %>
...
<asp:Content ContentPlaceHolderID="cpNBreadcrumb" runat="server">
 ...
 <asp:Content ContentPlaceHolderID="cpNTitle" runat="server">
    <div>
        <h6 class="slim-pagetitle"><asp:Literal ID="ltrTitle1" runat="server" Text="GST on Sales u/s 9(5) by ECO Detailed Report"></asp:Literal>
        ...
        <div class="card-header shadow_top">
            <div class="d-flex align-items-center row row-sm">
                <div class="col-lg-10 p-0 mb-2 mb-lg-0 flex-wrap flex-md-nowrap d-flex">
                    <div class="form-check form-switch mt-3 mt-lg-3 mb-2 mb-lg-0 col-lg-1 p-02 px-5" style="display:none">
                        <%--<label for="chkDetailed" runat="server"  class="form-control-label mb-1 w-100 tx-dark">&nbsp;</label>--%>
                        <asp:CheckBox ID="chkDetailed" AutoPostBack="true" OnCheckedChanged="chkDetailed_CheckedChanged" CssClass="form-check-input" runat="server" Text="&nbsp;&nbsp;&nbsp;Detailed" />
                    </div>
<%--                    <div class="col-lg-1 p-3 px-2 mb-2 mb-lg-1">
                        <asp:CheckBox ID="chkDetailed" CssClass="form-check-input" runat="server" Text="Detailed" />
                    </div>--%>
                    ...
                    <div ID="divdnldbtn" class="col-lg-2 input-group mb-2 mb-lg-0 p-0 px-2" runat="server">
                        <label for="btnDownload" runat="server"  class="form-control-label mb-1 w-100 tx-dark">&nbsp;</label>
                        <asp:Button ID="btnDownload" CssClass="btn btn-primary w-100 mt-2 mt-lg-0"  OnClick="btnDownload_Click" runat="server" Text="Detailed Download" />
                    </div>
                </div>
...
<%--                            <asp:ControlParameter ControlID="ddlStoreGroupBranch" Name="storeRefId" ConvertEmptyStringToNull="false" />--%>
                    ...
                    <asp:GridView AutoGenerateColumns="false" ID="gvDetailedReport" runat="server" CssClass="table table-bordered gridview_table" GridLines="None" BorderColor="#ECECEC"
                      AllowPaging="true" AllowSorting="true" ShowFooter="false" PagerSettings-Visible="true" PageSize="10" DataSourceID="sdsDetailedDownload" > 
                       <HeaderStyle HorizontalAlign="Center" />
                      <Columns>
                          <asp:BoundField HeaderText="Invoice Date" DataField="order_date" DataFormatString="{0:dd-MM-yyyy}">
					         <ItemStyle HorizontalAlign="Center" />
                          </asp:BoundField>
                          <asp:BoundField HeaderText="Invoice No." DataField="inv_number">
					         <ItemStyle HorizontalAlign="Center" />
                          </asp:BoundField>
                           <asp:BoundField HeaderText="Invoice on Behalf of" DataField="br_Name">
					         <ItemStyle HorizontalAlign="Center" />
                          </asp:BoundField>
                           <asp:BoundField HeaderText="Invoice to" DataField="order_customer_name">
					         <ItemStyle HorizontalAlign="Center" />
                          </asp:BoundField>
                            <asp:BoundField HeaderText="GSTIN" DataField="br_GST">
					         <ItemStyle HorizontalAlign="Center" />
                          </asp:BoundField>
                            <asp:BoundField HeaderText="State" DataField="st_name">
					         <ItemStyle HorizontalAlign="Center" />
                          </asp:BoundField>
                    ...
                    <asp:SqlDataSource runat="server" ID="sdsDetailedDownload" ConnectionString="<%$connectionStrings:mySqlConnection%>"  ProviderName="MySql.Data.MySqlClient"
                        SelectCommand = "" >
                        <SelectParameters>
                            <asp:controlparameter controlid="txtdatefrom" name="fromDate" convertemptystringtonull="false" />
                            <asp:controlparameter controlid="txtdateto" name="toDate" convertemptystringtonull="false" />
