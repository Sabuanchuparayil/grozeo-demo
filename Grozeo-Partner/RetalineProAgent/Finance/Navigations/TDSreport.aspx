<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TDSreport.aspx.cs" MasterPageFile="~/Finance/FinanceMaster.master" Inherits="RetalineProAgent.Finance.Navigations.TDSreport" %>
...
<asp:Content runat="server" ContentPlaceHolderID="cpNMainContent">
        ...
        <div class="row row-sm menucard">
            ...
            <div class="col-lg-6 mb-3 mb-lg-0">
              <a href="/Finance/ECOMITTDS" class="card h-100 p-4">
                <div class="card-body p-0 tx-left position-relative">
                  ...
                  <h5 class="card-title tx-medium mg-b-4 tx-16 tx-gray-700">Detailed IT-TDS Report</h5>
                  <p class="card-text mg-b-8 tx-12">IT-TDS transactions are defined here for a detailed analysis of statutory compliance</p>
                </div>
              </a>
            </div><!--col-lg-->
            ...
            <div class="col-lg-6 mb-3 mb-lg-0">
              <a href="/Finance/DailyITTDSReport.aspx" class="card h-100 p-4">
                <div class="card-body p-0 tx-left position-relative">
