<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Finance/FinanceMaster.master" CodeBehind="TaxesandDuties.aspx.cs" Inherits="RetalineProAgent.Finance.Navigations.TaxesandDuties" %>
...
<asp:Content ContentPlaceHolderID="cpNTitle" runat="server" ID="cTitle">
    <h6 class="slim-pagetitle">Taxes & Duties</h6>
    <p class="mb-0">Taxes & Duties</p>
</asp:Content>
...
<asp:Content runat="server" ContentPlaceHolderID="cpNMainContent">
        ...
        <div class="row row-sm menucard">
            ...
            <div class="col-lg-6 mb-3 mb-lg-0">
              <a href="/Finance/Navigations/GSTReports" class="card h-100 p-4">
                <div class="card-body p-0 tx-left position-relative">
                  ...
                  <h5 class="card-title tx-medium mg-b-4 tx-16 tx-gray-700">GST</h5>
                  <p class="card-text mg-b-8 tx-12">GST transactions are defined here for a detailed analysis of statutory compliance</p>
                </div>
              </a>
            </div><!--col-lg-->
            ...
            <div class="col-lg-6 mb-3 mb-lg-0">
              <a href="/Finance/Navigations/TDSreport" class="card h-100 p-4">
                <div class="card-body p-0 tx-left position-relative">
                  ...
                  <h5 class="card-title tx-medium mg-b-4 tx-16 tx-gray-700">TDS</h5>
