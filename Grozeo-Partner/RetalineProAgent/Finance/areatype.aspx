<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Finance/FinanceMaster.master" CodeBehind="areatype.aspx.cs" Inherits="RetalineProAgent.Finance.areatype" %>
...
<asp:Content ContentPlaceHolderID="cpNTitle" runat="server" ID="cTitle">
    <h6 class="slim-pagetitle">Area Type</h6>
     <p class="mb-0">You can see Area Type here</p>
</asp:Content>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" cellspacing="0" border="1">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Partner Area Associate</td>
                                    </tr>
                                     <tr>
                                        <td>2</td>
                                        <td>Partner Business Associate</td>
                                    </tr>
                                     <tr>
                                        <td>3</td>
                                        <td>Direct Area Associate</td>
                                    </tr>
                                     <tr>
                                        <td>4</td>
                                        <td>Direct Business Associate</td>
                                    </tr>
                                     <tr>
                                        <td>5</td>
                                        <td>Direct Enrolled Network</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
