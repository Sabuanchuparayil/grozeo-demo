<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Finance/FinanceMaster.master" CodeBehind="event_master.aspx.cs" Inherits="RetalineProAgent.Finance.event_master" %>
...
<asp:Content ContentPlaceHolderID="cpNTitle" runat="server" ID="cTitle">
    <h6 class="slim-pagetitle">Auto Posting Functions</h6>
     <p class="mb-0">You can see Auto Posting Functions here</p>
</asp:Content>
                    ...
                    <div class="card-body">
                        <div class="table-responsive" >
                            ...
                            <asp:SqlDataSource runat="server" ID="SDSCostpurpose" ProviderName="MySql.Data.MySqlClient" ConnectionString="<%$ ConnectionStrings:mySqlConnection %>"
                                SelectCommand="SELECT id,NAME FROM finance_event_master   WHERE (TRIM(@search) LIKE '' OR NAME LIKE CONCAT('%', @search, '%')) ORDER BY name">
                                <SelectParameters>
