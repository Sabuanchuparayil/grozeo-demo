<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Finance/FinanceMaster.master" CodeBehind="marginapplicable.aspx.cs" Inherits="RetalineProAgent.Finance.marginapplicable" %>
...
<asp:Content ContentPlaceHolderID="cpNTitle" runat="server" ID="cTitle">
    <h6 class="slim-pagetitle">Margin Applicable</h6>
     <p class="mb-0">You can see Margin Applicable here</p>
</asp:Content>
                    ...
                    <div class="card-body">
                        <div class="table-responsive" >
                            ...
                            <asp:SqlDataSource runat="server" ID="SDSCostpurpose" ProviderName="MySql.Data.MySqlClient" ConnectionString="<%$ ConnectionStrings:mySqlConnection %>"
                                SelectCommand="SELECT id,NAME FROM finance_margin_applicable WHERE (TRIM(@search) LIKE '' OR NAME LIKE CONCAT('%', @search, '%')) ORDER BY name ">
                                <SelectParameters>
