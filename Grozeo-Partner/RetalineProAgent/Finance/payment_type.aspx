<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Finance/FinanceMaster.master" CodeBehind="payment_type.aspx.cs" Inherits="RetalineProAgent.Finance.payment_type" %>
...
<asp:Content ContentPlaceHolderID="cpNTitle" runat="server" ID="cTitle">
    <h6 class="slim-pagetitle">Payment Type</h6>
    <p class="mb-0">You can see Payment Type here</p>
</asp:Content>
