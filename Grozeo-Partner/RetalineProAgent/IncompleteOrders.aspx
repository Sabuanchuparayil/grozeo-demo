<%@ Page Language="C#" AutoEventWireup="true" Title="Incomplete Orders" MasterPageFile="~/AgentMaster.Master" Async="true"  CodeBehind="IncompleteOrders.aspx.cs" Inherits="RetalineProAgent.IncompleteOrders" %>
                  ...
                  <ul class="navbar-nav mr-auto">
                   <%-- <li class="nav-item active mx-1">
                    ...
                    <li class="nav-item mx-1">
                      ...
                      <li class="nav-item active mx-1">
                        <asp:LinkButton ID="lbtnIncompleteOrds" runat="server" typeid="10" OnClick="btnFilterType_Click" CssClass="nav-link btn btn-block btn-outline-primary btn-sm p-1 px-2">Incomplete Orders</asp:LinkButton>
                    </li>

                      <%--<li class="nav-item active mx-1">
                        <asp:LinkButton ID="lbtSchedulePacking" runat="server" typeid="11" OnClick="btnFilterType_Click" CssClass="nav-link btn btn-block btn-outline-primary btn-sm p-1 px-2">Scheduled Packing</asp:LinkButton>
                    </li>
                   ...
                   <asp:HiddenField ID="hidFilterType" runat="server" />
                        ...
                        <asp:Image runat="server" ID="image" ImageAlign="AbsMiddle" width="30" ImageUrl="https://grozeo.azurewebsites.net/images/processing.gif" 
                            Visible='<%# ( (new int[]{5, 11 }).Contains(Convert.ToInt32(Eval("StatusId"))) ? true: false) %>' />
                                    ...
                                    ? true: false) %>' OnClientClick="javascript:confirm('Do you wish to move this order to pending order?');"/>
                                ...
                                <asp:SqlDataSource runat="server" ID="SDSPendingOrders" ProviderName="MySql.Data.MySqlClient" OnSelected="SDSPendingOrders_Selected" ConnectionString="<%$ ConnectionStrings:mySqlConnection %>"
                                 SelectCommand = "SELECT DISTINCT bco.order_id,bco.order_order_id,bco.order_total_amount,order_packedbags_count,bco.order_customer_id,order_branch_type_id,br_Lat,br_Lng,br_ID,
                                                  ...
                                                  WHERE bco.status_id > 0 AND bco.status_id >= 4 and (ifnull(@filterType, 0) = 0 
                                                     or (@filterType = 1 and bco.status_id NOT IN(9,17,18,19,23,24,25,34))  
