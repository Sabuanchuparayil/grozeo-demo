<%@ Page Language="C#" AutoEventWireup="true" Async="true" MasterPageFile="~/Tenant/TenantMaster.master" ValidateRequest="false" CodeBehind="AboutContent.aspx.cs" Inherits="RetalineProAgent.AboutContent" %>
        ...
        <div class="card-body p-3 shadow_top">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <p class="lead mb-0">Add/edit about us</p>
                ...
                <div class="col-12">
                    <div class="d-inline-block">
                        <div class="input-group">
                            <asp:Button runat="server" ID="btnSaveAbout" OnClientClick="loadSummernoteContent()" OnClick="btnSaveAbout_Click" CssClass="btn btn-primary float-right" Text="Save Content" />
...
<script>
    ...
    $(function () {
        ...
        $('#modaldemo4').on('hidden.bs.modal', function (e) {
            window.location.href = "/Tenant/AboutContent";
        });
    });
</script>
