<%@ Page Language="C#" AutoEventWireup="true" Async="true" MasterPageFile="~/Tenant/TenantMaster.master" ValidateRequest="false" CodeBehind="Settings.aspx.cs" Inherits="RetalineProAgent.Appearance.Settings" %>
...
<asp:Content ContentPlaceHolderID="cpBreadcrumb" runat="server">
    ...
    <li class="breadcrumb-item"><a href="/navigations/StoreConfig">Store</a></li>
...
<asp:Content ContentPlaceHolderID="cpTitle" runat="server" ID="cTitle"><h6 class="slim-pagetitle"> Content Pages</h6></asp:Content>
