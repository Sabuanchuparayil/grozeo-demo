<%@ Page Language="C#" MasterPageFile="~/Tenant/TenantMaster.master" Title="Delivery Rules" AutoEventWireup="true" CodeBehind="DelivRules.aspx.cs" Inherits="RetalineProAgent.DelivRules" %>
                ...
                <div class="col-12 delivery_rules_wrap">
                    ...
                    <div class="type_of_delivery d-flex flex-wrap p-3 mb-3 card-body hyperlocal_delivery_type">
                        ...
                        <div class="deliveryTitle d-flex w-100">
                            <label class="ckbox fw-bold w-auto">
                                <input id="hyperlocal_delivery" class="chk check_delivery_type" type="checkbox" runat="server">
                                <span class="tx-uppercase tx-bold">Hyperlocal Delivery</span>
                            </label>
                        </div>

                        <div class="type_delivery_dteails p-2 deliveryDteails w-100 disabled">
                            <div class="manage_delivery d-flex flex-wrap flex-md-nowrap">
                                <label class="rdiobox mr-4">
                                    <input id="store_hyperlocal" name="hyperlocal_delivery" type="radio" value="store_hyperlocal" class="DeliByGroze">
                                    <span class="p-0">Store will manage delivery</span>
                                </label>

                                <label class="rdiobox">
                                    <input id="grozeo_hyperlocal" name="hyperlocal_delivery" type="radio" value="grozeo_hyperlocal" class="DeliByGroze">
                                    <span class="p-0">Let Grozeo manage delivery</span>
                                </label>
                            </div>
                            <!--manage_delivery-->

                            <div class="d-flex flex-wrap py-1 type_of_charge DeliveryCharge hide">
                                ...
                                <div class="d-flex flex-wrap w-100 mt-1 chargedtails">
                                    <div class="d-flex flex-wrap py-1 fixedharges hide">
...
<%--                                            <input runat="server" class="form-control wd-55 mx-1 ht-20 py-0 text-center" type="text" maxlength="5" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">--%>
                                            Rupees
                                        </div>
                                    </div>

                                    <div class="d-flex flex-wrap py-1 Dynamiccharges hide">
...
<%--                                            <input runat="server" class="form-control wd-55 mx-1 ht-20 py-0 text-center" maxlength="5" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">--%>
                                            Km
                                        </div>
                                        <div class="d-flex align-items-center w-auto mr-3 mr-lg-4 mb-2 mb-lg-0">
                                            Max Weight
                                            <asp:TextBox runat="server" ID="dynamicMaxWeight" CssClass="form-control wd-55 mx-1 ht-20 py-0 text-center" MaxLength="5" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></asp:TextBox>
<%--                                            <input runat="server" class="form-control wd-55 mx-1 ht-20 py-0 text-center" maxlength="5" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">--%>
                                            Kg
                                        </div>
                                        <div class="d-flex align-items-center w-auto mr-3 mr-lg-4 mb-2 mb-lg-0">
...
<%--                                            <input runat="server" class="form-control wd-55 mx-1 ht-20 py-0 text-center" maxlength="5" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">--%>
                        ...
                        <!--type_delivery_dteails-->

                    </div>
                    <!--hyperlocal_delivery_type-->

                    <div class="type_of_delivery d-flex flex-wrap p-3 mb-3 card-body local_delivery_type">

                        <div class="deliveryTitle d-flex w-100">
                            <label class="ckbox fw-bold w-auto">
                                <input id="local_delivery" class="chk check_delivery_type" type="checkbox" runat="server">
                                <span class="tx-uppercase tx-bold">Scheduled Local Delivery</span>
                            </label>
                        </div>
...
<%--                                            <input class="form-control wd-55 mx-1 ht-20 py-0 text-center" maxlength="5" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">--%>
                                        ...
                                        <div class="d-flex align-items-center w-auto mr-0 mr-lg-4 mb-2 mb-lg-0 mb-lg-0">
                                            Max Weight
                                            <asp:TextBox runat="server" ID="txtSldDynamicMaxWeight" CssClass="form-control wd-55 mx-1 ht-20 py-0 text-center" MaxLength="5" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></asp:TextBox>
<%--                                            <input class="form-control wd-55 mx-1 ht-20 py-0 text-center" maxlength="5" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">--%>
                                            Kg
                                        </div>
                                        <div class="d-flex align-items-center w-auto mr-0 mr-lg-4 mb-2 mb-lg-0 mb-lg-0">
                    ...
                    <div class="type_of_delivery d-flex flex-wrap p-3 mb-3 card-body long_delivery_type">
                        ...
                        <div class="deliveryTitle d-flex w-100">
                            <label class="ckbox w-auto">
                                <input id="long_delivery" class="chk check_delivery_type" type="checkbox" runat="server">
                                <span  class="tx-uppercase tx-bold">Local Last Mile Delivery</span>
                            </label>
                        </div>
                        ...
                        <div class="type_delivery_dteails p-2 deliveryDteails w-100 disabled">
                            <div class="manage_delivery d-flex flex-wrap flex-md-nowrap">
                                ...
                                <label class="rdiobox mr-4">
                                    <input id="store_long" name="long_delivery" type="radio" value="store_long" class="DeliByGroze">
                                    <span class="p-0">Store will manage delivery</span>
                                </label>

                                <label class="rdiobox">
                                    <input id="grozeo_long" name="long_delivery" type="radio" value="grozeo_long" class="DeliByGroze">
                                    <span class="p-0">Let Grozeo manage delivery</span>
                                </label>
                            </div>
                            <!--col-12-->
...
<%--                                            <input class="form-control wd-55 mx-1 ht-20 py-0 text-center" maxlength="5" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">--%>
                                        ...
                                        <div class="d-flex align-items-center w-auto mr-0 mr-lg-4 mb-2 mb-lg-0 mb-lg-0">
                                            Max Weight
                                            <asp:TextBox runat="server" ID="txtLlmDynamicMaxWeight" CssClass="form-control wd-55 mx-1 ht-20 py-0 text-center" MaxLength="5" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></asp:TextBox>
<%--                                            <input class="form-control wd-55 mx-1 ht-20 py-0 text-center" maxlength="5" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">--%>
                                            Kg
                                        </div>
                                        <div class="d-flex align-items-center w-auto mr-0 mr-lg-4 mb-2 mb-lg-0 mb-lg-0">
                    ...
                    <div class="type_of_delivery d-flex flex-wrap p-3 mb-3 card-body courier_delivery_type">
                        ...
                        <div class="deliveryTitle d-flex w-100">
                            <label class="ckbox w-auto mr-2">
                                <input id="courier_delivery" class="chk check_delivery_type" type="checkbox" runat="server">
                                <span class="tx-uppercase tx-bold">Courier Delivery</span>
                            </label>
                        ...
                        <div class="type_delivery_dteails p-2 deliveryDteails w-100 disabled">
                            <div class="manage_delivery d-flex flex-wrap flex-md-nowrap">
                                ...
                                <label class="rdiobox mr-4">
                                    <input id="store_courier" name="courier_delivery" type="radio" value="store_courier" class="DeliByGroze">
                                    <span class="p-0">Store will manage delivery</span>
                                </label>

                                <label class="rdiobox">
                                    <input id="grozeo_courier" name="courier_delivery" type="radio" value="grozeo_courier" class="DeliByGroze">
                                    <span class="p-0">Let Grozeo manage delivery</span>
                                </label>
                            </div>
                            <!--col-12-->
                                            ...
                                            <div class="slablist p-1 p-sm-2 border mb-1">
                                                <div class="d-flex align-items-baseline align-items-sm-center flex-wrap flex-sm-nowrap">
                                                    <div class="d-flex align-items-center mr-2 mr-sm-3 mb-0 mb-sm-0">
                                                        <asp:DropDownList CssClass="form-control wd-70 mr-1" runat="server">
                                                        ...
                                                        <asp:TextBox runat="server" ID="courierDistSlabKm" CssClass="form-control wd-50 mx-1 ht-20 py-0 text-center" MaxLength="5" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></asp:TextBox>
<%--                                                        <input class="form-control wd-50 mx-1 ht-20 py-0 text-center" maxlength="5" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">--%>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <asp:TextBox runat="server" ID="courierDistSlabRate" CssClass="form-control wd-50 mx-1 ht-20 py-0 text-center" MaxLength="5" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></asp:TextBox>
<%--                                                        <input class="form-control wd-50 mx-1 ht-20 py-0 text-center" maxlength="5" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">--%>
                                                        ₹/ Km
                                                    </div>
                                                    <div class="addcharge ml-2 ml-sm-3">
                                                        <asp:LinkButton CssClass="bg-transparent btn p-1 addcharge_btn d-flex align-items-center justify-content-center" runat="server"><i class="fa-regular fa-plus tx-16"></i></asp:LinkButton>
<%--                                                        <button class="bg-transparent btn p-1 addcharge_btn d-flex align-items-center justify-content-center"><i class="fa-regular fa-plus tx-16"></i></button>--%>
                                            ...
                                            <asp:Repeater ID="courierDistanceSlab" runat="server" >
                                                <ItemTemplate>
                                                    <div class="slablist p-1 p-sm-2 border mb-1">
                                                <div class="d-flex align-items-baseline align-items-sm-center flex-wrap flex-sm-nowrap">
                                                    <div class="d-flex align-items-center mr-2 mr-sm-3 mb-0 mb-sm-0">
...
<%--                                                <input class="form-control wd-55 mx-1 ht-20 py-0 text-center" type="text" maxlength="5" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">--%>
                    ...
                    <div class="type_of_delivery d-flex flex-wrap p-3 mb-3 card-body parcel_delivery_type">
                        ...
                        <div class="deliveryTitle d-flex w-100">
                            <label class="ckbox w-auto mr-2">
                                <input id="parcel_delivery" class="chk check_delivery_type" type="checkbox" runat="server">
                                <span class="tx-uppercase tx-bold">Parcel Delivery</span>
                            </label>
                        ...
                        <div class="type_delivery_dteails p-2 deliveryDteails w-100 disabled">
                            <div class="manage_delivery d-flex flex-wrap flex-md-nowrap">
                                ...
                                <label class="rdiobox mr-4">
                                    <input id="store_parcel" name="parcel_delivery" type="radio" value="store_parcel" class="DeliByGroze">
                                    <span class="p-0">Store will manage delivery</span>
                                </label>

                                <label class="rdiobox">
                                    <input id="grozeo_parcel" name="parcel_delivery" type="radio" value="grozeo_parcel" class="DeliByGroze">
                                    <span class="p-0">Let Grozeo manage delivery</span>
                                </label>
                            </div>
                            <!--col-12-->
...
<%--                                                <input class="form-control wd-55 mx-1 ht-20 py-0 text-center" type="text" maxlength="5" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">--%>
                    ...
                    <div class="type_of_delivery d-flex flex-wrap p-3 mb-3 card-body cargo_delivery_type">
                        ...
                        <div class="deliveryTitle d-flex w-100">
                            <label class="ckbox w-auto mr-2">
                                <input id="cargo_delivery" class="chk check_delivery_type" type="checkbox" runat="server">
                                <span class="tx-uppercase tx-bold">Cargo Delivery</span>
                            </label>
                        ...
                        <div class="type_delivery_dteails p-2 deliveryDteails w-100 disabled">
                            <div class="manage_delivery d-flex flex-wrap flex-md-nowrap">
                                ...
                                <label class="rdiobox mr-4">
                                    <input id="store_cargo" name="cargo_delivery" type="radio" value="store_cargo" class="DeliByGroze">
                                    <span class="p-0">Store will manage delivery</span>
                                </label>

                                <label class="rdiobox">
                                    <input id="grozeo_cargo" name="cargo_delivery" type="radio" value="grozeo_cargo" class="DeliByGroze">
                                    <span class="p-0">Let Grozeo manage delivery</span>
                                </label>
                            </div>
                            <!--col-12-->
                    ...
                    <div class="type_of_delivery d-flex flex-wrap p-3 mb-3 card-body manual_delivery_type">
                        ...
                        <div class="deliveryTitle d-flex w-100">
                            <label class="ckbox w-auto">
                                <input id="manual_delivery" class="chk check_delivery_type" type="checkbox" runat="server">
                                <span class="tx-uppercase tx-bold">Manual Delivery</span>
                            </label>
                        </div>

                        <div class="type_delivery_dteails p-2 w-100 ManualDelivery disabled">
...
<%--                                                <input class="form-control wd-55 mx-1 ht-20 py-0 text-center" type="text" maxlength="5" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">--%>
                    ...
                    <div class="type_of_delivery d-flex flex-wrap p-3 mb-3 card-body share_delivery_type">
                        ...
                        <div class="deliveryTitle d-flex w-100">
                            <label class="ckbox w-auto">
                                <input id="share_delivery" class="chk check_delivery_type" type="checkbox" runat="server">
                                <span class="tx-uppercase tx-bold">Delivery Cost Share</span>
                            </label>
                        </div>
                                ...
                                <div class="d-flex flex-wrap w-100 chargedtails">
                                    ...
                                    <div class="d-flex flex-wrap py-1">
                                        <div class="d-flex flex-wrap align-items-center w-auto">
                                            ...
                                            <%--<input class="form-control wd-55 mx-1 ht-20 py-0 mb-1 text-center" type="text" maxlength="5" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">% --%>%subject to
...
<%--                                            <input class="form-control wd-55 mx-1 ht-20 py-0 mb-1 text-center" type="text" maxlength="5" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">--%>% of product value or Rs.
    ...
    <script>
        ...
        jQuery(document).ready(function ($) {
            ...
            //$('#selectstore').multiselect();
            var deliveryrules = function () {
                var deliveryrulesMethods = {}, deliveryrulesPrivateMethods = {};

                deliveryrulesMethods.events = {};

                deliveryrulesPrivateMethods.controls = {
                    deliveryTypeControl: ".check_delivery_type",

                    hyperlocalDelivery: "hyperlocal_delivery",
                    grozeoHyperlocal: "grozeo_hyperlocal",
                    storeHyperlocal: "store_hyperlocal",

                    localDelivery: "local_delivery",
                    grozeoLocal: "grozeo_local",
                    storeLocal: "store_local",

                    longDelivery: "long_delivery",
                    grozeoLong: "grozeo_long",
                    storeLong: "store_long",

                    courierDelivery: "courier_delivery",
                    grozeoCourier: "grozeo_courier",
                    storeCourier: "store_courier",

                    parcelDelivery: "parcel_delivery",
                    grozeoParcel: "grozeo_parcel",
                    storeParcel: "store_parcel",

                    cargoDelivery: "cargo_delivery",
                    grozeoCargo: "grozeo_cargo",
                    storeCargo: "store_cargo",

                };


                deliveryrulesPrivateMethods.grozo_delivery = function (a, b, c) {
                    var delivery = document.getElementsByName(a);
                    for (var elem in delivery) {
                        if (delivery[elem].checked) {
                            if (delivery[elem].value == b) {
                                $(delivery[elem]).parent().closest('.deliveryDteails').find('.type_of_charge').addClass('hide');

                                $(delivery[elem]).parent().closest('.deliveryDteails').find('.fixedharges').addClass('hide');
                                $(delivery[elem]).parent().closest('.deliveryDteails').find('.Dynamiccharges').addClass('hide');

                                // Find radio buttons within the context of the changed element
                                var radioTypeCharge = $(delivery[elem]).parents('.deliveryDteails').find('.type_of_charge').find('input[type="radio"]');
                                // Uncheck all found radio buttons
                                radioTypeCharge.prop('checked', false);

                                var textField = $(delivery[elem]).parents('.type_of_delivery').find('input[type="text"]')
                                // Checkbox is unchecked, clear the text field
                                textField.val("");

                            } else if (delivery[elem].value == c) {
                                $(delivery[elem]).parent().closest('.deliveryDteails').find('.type_of_charge').removeClass('hide');
                            }
                        }
                    }
                }
                ...
                deliveryrulesMethods.initializePage = function () {
                    deliveryrulesMethods.events.initialize();
                };

                deliveryrulesMethods.events.initialize = function () {
                    var controls = deliveryrulesPrivateMethods.controls;

                    $('.DeliByGroze').unbind("change").on("change", function ($event) {
                        let targetElem = $event.currentTarget.value;
                        let a, b, c = "";
                        $(this).parents('.type_of_delivery').find('.DeliveryCharge').removeClass('hide')
                        switch (targetElem) {
                            case controls.storeHyperlocal:
                            case controls.grozeoHyperlocal:
                                a = controls.hyperlocalDelivery, b = controls.grozeoHyperlocal, c = controls.storeHyperlocal
                                break;
                            case controls.storeLocal:
                            case controls.grozeoLocal:
                                a = controls.localDelivery, b = controls.grozeoLocal, c = controls.storeLocal
                                break;
                            case controls.storeLong:
                            case controls.grozeoLong:
                                a = controls.longDelivery, b = controls.grozeoLong, c = controls.storeLong
                                break;
                            case controls.storeCourier:
                            case controls.grozeoCourier:
                                a = controls.courierDelivery, b = controls.grozeoCourier, c = controls.storeCourier
                                break;
                            case controls.storeParcel:
                            case controls.grozeoParcel:
                                a = controls.parcelDelivery, b = controls.grozeoParcel, c = controls.storeParcel
                                break;

                            case controls.storeCargo:
                            case controls.grozeoCargo:
                                a = controls.cargoDelivery, b = controls.grozeoCargo, c = controls.storeCargo
                                break;

                        }
                        deliveryrulesPrivateMethods.grozo_delivery(a, b, c);
                    });

                    $('body').on('change', controls.deliveryTypeControl, function () {
                        if ($(this).is(':checked')) {

                            $(this).parents('.type_of_delivery').find('.deliveryDteails').removeClass('disabled');
                            $(this).parents('.type_of_delivery').find('.ManualDelivery').removeClass('disabled');
                        } else {
                            $(this).parents('.type_of_delivery').find('.deliveryDteails').addClass('disabled');
                            $(this).parents('.type_of_delivery').find('.ManualDelivery').addClass('disabled');
                            $(this).parents('.type_of_delivery').find('.DeliveryCharge').addClass('hide raihhan');
                            $(this).parents('.type_of_delivery').find('.fixedharges').addClass('hide');
                            $(this).parents('.type_of_delivery').find('.Dynamiccharges').addClass('hide');

                            // Find radio buttons within the context of the changed element
                            var radioManageDelivery = $(this).parents('.type_of_delivery').find('input[type="radio"]');
                            var radioTypeCharge = $(this).parents('.type_delivery_dteails').find('.type_of_charge').find('input[type="radio"]');
                            // Uncheck all found radio buttons
                            radioManageDelivery.prop('checked', false);
                            radioTypeCharge.prop('checked', false);

                            var textField = $(this).parents('.type_of_delivery').find('input[type="text"]')
                            // Checkbox is unchecked, clear the text field
                            textField.val("");
                        }
                    });
                    ...
                    // charge type switch
                    $('.chargetypeswitch').unbind("change").on("change", function ($event) {
                        if ($event.target.id.includes('Fixed')) {
                            $(this).parents('.type_of_charge').find('.fixedharges').removeClass('hide');
                            $(this).parents('.type_of_charge').find('.Dynamiccharges').addClass('hide');
                        } else {
                            $(this).parents('.type_of_charge').find('.Dynamiccharges').removeClass('hide');
                            $(this).parents('.type_of_charge').find('.fixedharges').addClass('hide');

                            var textField = $(this).parents('.type_of_charge').find('input[type="text"]')
                            // Checkbox is unchecked, clear the text field
                            textField.val("");

                            var selectDropdown = $(this).parents('.type_of_charge').find('select');
                            //selectDropdown.val(selectedOption);

                            console.log($(this).parents('.type_of_charge').find('select'))
                        }
                    });
                ...
                return deliveryrulesMethods;
            }();
            $(function () {
                deliveryrules.initializePage();
            });
