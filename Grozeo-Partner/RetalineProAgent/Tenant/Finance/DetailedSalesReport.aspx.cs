...
{
    public partial class DetailedSalesReport: Base.BasePartnerPage
    {
        ...
        protected void ODSSalesReport_Selecting(object sender, ObjectDataSourceSelectingEventArgs e)
        {
        ...
        protected void gvdailySalesReport_RowDataBound1(object sender, GridViewRowEventArgs e)
        {
            ...
            double total = 0; try { total = Convert.ToDouble(DataBinder.Eval(e.Row.DataItem, "total")); } catch { }
            double totals = sales + delCharges + taxes;
            double amountdue = total - pgcharges - delCharges1 - tcs - tds - orderRefund;
        ...
        {
            string selectedValue = seldate.SelectedValue;
