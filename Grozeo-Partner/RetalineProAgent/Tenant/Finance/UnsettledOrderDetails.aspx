<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnsettledOrderDetails.aspx.cs"  MasterPageFile="~/Tenant/TenantMaster.master" Inherits="RetalineProAgent.Tenant.Finance.UnsettledOrderDetails" %>
...
<asp:Content ContentPlaceHolderID="cpTitle" runat="server">
    <div>
        ...
        <asp:Literal ID="ltrTitle1" runat="server" Text="Daily Sales Report">Unsettled Order Details</asp:Literal>
        <asp:Literal ID="ltrBranchName" runat="server"></asp:Literal>
    </h6>
        <p class="mb-0">Clear and Concise Unsettled Order Details</p>
    </div>    
</asp:Content>
