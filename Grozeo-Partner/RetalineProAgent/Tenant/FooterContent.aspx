<%@ Page Language="C#" AutoEventWireup="true" Async="true" MasterPageFile="~/Tenant/TenantMaster.master" ValidateRequest="false" CodeBehind="FooterContent.aspx.cs" Inherits="RetalineProAgent.FooterContent" %>
...
<asp:Content ContentPlaceHolderID="cpTitle" runat="server" ID="cTitle"><h6 class="slim-pagetitle"> Footer Content</h6></asp:Content>
...
<asp:Content ContentPlaceHolderID="cpMainContent" runat="server">
    ...
    <div class="section-wrapper p-3">
        ...
        <p class="mg-b-20 mg-sm-b-20">Changes in the display settings can impact the looks and feel as well as components used.</p>
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <p class="lead mb-0">Add/edit footer content</p>
                    ...
                    <textarea runat="server" id="taFooterContent" class="txtrichtext"></textarea>
            ...
            <asp:Button runat="server" ID="btnSaveTerms" OnClientClick="loadSummernoteContent()" OnClick="btnSaveTerms_Click" CssClass="btn btn-success float-right" Text="Save Content"/>
