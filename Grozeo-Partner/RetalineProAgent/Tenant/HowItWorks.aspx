<%@ Page Language="C#" AutoEventWireup="true" Async="true" MasterPageFile="~/Tenant/TenantMaster.master" ValidateRequest="false" CodeBehind="HowItWorks.aspx.cs" Inherits="RetalineProAgent.HowItWorks" %>
...
<asp:Content ContentPlaceHolderID="cpTitle" runat="server" ID="cTitle">
    <div>
        <h6 class="slim-pagetitle">How It Works</h6>
        <p class="mb-0">Info Settings</p>
    </div>
</asp:Content>
        ...
        <div class="card-body p-3 shadow_top">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <p class="mb-0">Add/edit how it works</p>
                    ...
                    <textarea runat="server" id="taWork" class="txtrichtext"></textarea>
                ...
                <div class="col-12">
                    <div class="d-inline-block">
                        <div class="input-group">
                            <asp:Button runat="server" ID="btnSaveInfoContent" OnClientClick="loadSummernoteContent()" OnClick="btnSaveInfoContent_Click" CssClass="btn btn-primary float-right" Text="Save Content" />
