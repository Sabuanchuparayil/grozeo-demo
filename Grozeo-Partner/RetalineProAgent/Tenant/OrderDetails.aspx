<%@ Page Language="C#" AutoEventWireup="true" Async="true" Title="Order Details" MasterPageFile="~/Tenant/TenantMaster.master" CodeBehind="OrderDetails.aspx.cs" Inherits="RetalineProAgent.OrderDetails" %>
...
<asp:PlaceHolder ID="plcActionButtonsRow" runat="server">
    <div class="card">
        <div class="card-header p-0 m-0" style="overflow: hidden!important">
            ...
            <div id="dvNoneSponsored" runat="server" class="row row-sm p-3 align-items-end">
            ...
            <%--<div id=""  class="d-flex align-items-end flex-wrap flex-md-nowrap p-3">
                <div class="col-12 col-md-auto p-0 mb-2 mb-md-0 mr-0 mr-md-3 mb-3 mb-md-0" >
                </div>
                <div class="col-12 col-md-auto p-0 mb-2 mb-md-0 mr-0 mr-md-3" >
                    </div>
                <div class="col-12 col-md-auto p-0 mb-2 mb-md-0" >
