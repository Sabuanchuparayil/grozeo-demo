<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Tenant/TenantMaster.Master" Title="Profile" CodeBehind="Profile.aspx.cs" Inherits="RetalineProAgent.Tenant.Profile" %>
              ...
              <div class="card-body p-3">
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p class="card-profile-position "><asp:Literal ID="ltrRole"  runat="server"></asp:Literal> : <a class="tx-bold" href="/"><%= this.CurrentUser.StoreGroupName %></a></p>
              ...
              <div class="card-body p-3">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p class="position-year">Store Created on: <%= this.CurrentUser.CreatedOn.ToString("dd/MMM/yyyy") %> &nbsp;&nbsp;</p>
                  </div><!-- media-body -->
                </div><!-- media -->
              </div><!-- card-body -->
              <div class="card-footer">
