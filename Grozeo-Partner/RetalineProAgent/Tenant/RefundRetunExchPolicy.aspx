<%@ Page Language="C#" AutoEventWireup="true" Async="true" MasterPageFile="~/Tenant/TenantMaster.master" ValidateRequest="false" CodeBehind="RefundRetunExchPolicy.aspx.cs" Inherits="RetalineProAgent.RefundRetunExchPolicy" %>
...
<asp:Content ContentPlaceHolderID="cpTitle" runat="server" ID="cTitle">
    <div>
        <h6 class="slim-pagetitle">Refund, Return, and Exchange Policy</h6>
        <p class="mb-0">Explore our return and refund policy designed to ensure smooth, simple, and stress-free order resolutions</p>
    </div>
    </asp:Content>
        ...
        <div class="card-body p-3 shadow_top">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <p class="lead mb-0">Add/edit refund, return, and exchange policy</p>
                    <p><small>The info pages will load when the corresponding link in the footer is clicked. If the specified content is missing, default content will be loaded.</small></p>
                ...
                <div class="col-12">
                    <div class="d-inline-block">
                        <div class="input-group">
                            <asp:Button runat="server" ID="btnSaveAbout" OnClientClick="loadSummernoteContent()" OnClick="btnSaveAbout_Click" CssClass="btn btn-primary float-right" Text="Save" />
...
<script>
    ...
    $(function () {
        ...
        $('#modaldemo4').on('hidden.bs.modal', function (e) {
            window.location.href = "/Tenant/RefundRetunExchPolicy";
        });
    });
</script>
