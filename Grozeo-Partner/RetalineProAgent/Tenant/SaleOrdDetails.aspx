<%@ Page Language="C#" AutoEventWireup="true" Async="true" Title="Order Details" MasterPageFile="~/Tenant/TenantMaster.master" CodeBehind="SaleOrdDetails.aspx.cs" Inherits="RetalineProAgent.SaleOrdDetails" %>


<%--<asp:Content ContentPlaceHolderID="cntHeaderContainer" runat="server"></asp:Content>--%>
<asp:Content ContentPlaceHolderID="cpBreadcrumb" runat="server">
    <%--<li class="breadcrumb-item"><a href="/">Home</a></li>
    <li class="breadcrumb-item"><a href="/Tenant/SaleAndReturnOrders">Sales & Orders</a></li>
    <li class="breadcrumb-item active" aria-current="page">Order Details</li>--%>
    <a href="/Tenant/SaleAndReturnOrders"><i class="fa fa-reply mr-2" aria-hidden="true"></i>Back</a>
</asp:Content>
                ...
                <div class="col-12 col-md-6 card-columns card_columns_one">
                    ...
                    <div class="btn-group ml-2">
                            ...
                            <asp:GridView AutoGenerateColumns="false" ID="gvItemDetails" PageSize="10" runat="server" GridLines="None" CssClass="table table-bordered"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Item Name">
                                        <ItemTemplate>
                                            <%# Eval("stit_SKU") %>  
                                             <asp:Label ID="lblReturn" runat="server"  ForeColor="Red" Visible='<%# Convert.ToInt32(Eval("item_return_qty_requested")) > 0 %>'><small>Return Initiated</small></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                        ...
                        <asp:SqlDataSource runat="server" ID="SDSItemDetails" ProviderName="MySql.Data.MySqlClient" ConnectionString="<%$ ConnectionStrings:mySqlConnection %>"
                            SelectCommand="SELECT customer_order_id,item_sales_price,item_return_qty_requested,
