<%@ Page Language="C#" AutoEventWireup="true" Async="true" MasterPageFile="~/Tenant/TenantMaster.master" ValidateRequest="false" CodeBehind="TermsOfUse.aspx.cs" Inherits="RetalineProAgent.TermsOfUse" %>
...
<asp:Content ContentPlaceHolderID="cpTitle" runat="server" ID="cTitle">
    <div>
        <h6 class="slim-pagetitle">Terms Of Use</h6>
        ...
        <div class="card-body p-3 shadow_top">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <p class="mb-0">Add/edit terms & conditions of use</p>
                    ...
                    <textarea runat="server" id="taTermsConditions" class="txtrichtext"></textarea>
