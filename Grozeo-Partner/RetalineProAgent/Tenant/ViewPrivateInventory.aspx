<%@ Page Language="C#" MasterPageFile="~/Tenant/TenantMaster.master" Title="Products" ValidateRequest="false" AutoEventWireup="true" CodeBehind="ViewPrivateInventory.aspx.cs" Inherits="RetalineProAgent.ViewPrivateInventory" %>

<%@ Register Src="~/Controls/StoreSettings/ctrlViewProduct.ascx" TagPrefix="uc1" TagName="ctrlViewProduct" %>
...
<asp:Content ContentPlaceHolderID="cpTitle" runat="server" ID="cTitle">
    <h6 class="slim-pagetitle"> View Product</h6>
...
<asp:Content runat="server" ContentPlaceHolderID="cpMainContent">
    <div class="card">
        ...
        <uc1:ctrlViewProduct runat="server" ID="ctrlViewProduct" />
        </div>
    </div>
