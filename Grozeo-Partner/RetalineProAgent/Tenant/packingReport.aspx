<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Tenant/TenantMaster.master" CodeBehind="packingReport.aspx.cs" Inherits="RetalineProAgent.Tenant.packingReport" %>
<asp:Content ContentPlaceHolderID="cpBreadcrumb" runat="server">
    <%--<li class="breadcrumb-item"><a href="/">Home</a></li>
    <li class="breadcrumb-item"><a href="/navigations/accounts">Accounts & MIS</a></li>    
    <li class="breadcrumb-item active" aria-current="page">Packing Reports</li>--%>
    <a href="/Navigations/Accounts"><i class="fa fa-reply mr-2" aria-hidden="true"></i>Back</a>
</asp:Content>
<asp:Content ContentPlaceHolderID="cpTitle" runat="server">
    <div>
        <h6 class="slim-pagetitle">
        <asp:Literal ID="ltrTitle1" runat="server" Text="Packing Reports"></asp:Literal>       
    </h6>
        <p class="mb-0">Efficient Packing Insights</p>
    </div>
        ...
        <div class="card-header shadow_top">
            <div class="d-flex align-items-end row row-sm">
                ...
                <div class="col-sm-4 col-lg-2 d-flex align-items">
                    ...
                    <asp:Button runat="server" ID="btnreset" CssClass="btn btn-outline-primary mt-2 mt-lg-0 ml-2"  PostBackUrl="~/Tenant/packingReport.aspx" Text="Reset" />
<%--                     <a class="btn btn-outline-primary mt-2 mt-lg-0 ml-2" href="javascript:void(0)">Reset</a>--%>
        ...
        <div class="card-body">
            <div class="table-responsive">
                                <asp:GridView AutoGenerateColumns="false" ID="gvpacking" runat="server" CssClass="table table-bordered gridview_table" 
                                    AllowPaging="true" AllowSorting="true" ShowFooter="true" PagerSettings-Visible="true" PageSize="10" OnDataBound="gvpacking_DataBound" DataSourceID="SDSpacking">
                                    <Columns>
                                ...
                                <asp:SqlDataSource runat="server" ID="SDSpacking" ProviderName="MySql.Data.MySqlClient" ConnectionString="<%$ ConnectionStrings:mySqlConnection %>"
                                 SelectCommand="SELECT order_order_id,order_confirm_date,TIME(order_confirmed_on) AS ordertime,br_name,rd.order_customer_id,cust_customer_name,
                                    ...
                                    FROM  retaline_customer_order rc
                                    INNER JOIN finascop_branch b  ON order_branch_id=br_id  
                                    ...
                                    WHERE status_id>=9 and rc.storegroup_id=@storegroup AND (@branchid <= 0 or b.br_ID=@branchid)
                                    ...
                                    AND (trim(ifnull(@search, '')) like '' or order_order_id like CONCAT('%', @search, '%'))  GROUP BY order_order_id"
                                                                                         OnSelecting="SDSpacking_Selecting">
                                    <SelectParameters>
