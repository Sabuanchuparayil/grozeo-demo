namespace Retaline.Core.Http
{
    ...
    /// </summary>
    public static partial class RetalineHttpDefaults
    {
        /// <summary>
        ...
        /// </summary>
        public static string IsPostBeingDoneRequestItem => "retln.IsPOSTBeingDone";
        ...
        /// </summary>
        public static string GenericRouteInternalRedirect => "retln.RedirectFromGenericPathRoute";
    }
}