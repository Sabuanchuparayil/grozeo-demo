...
//using Retaline.Core.Infrastructure.Mapper;

namespace Retaline.Core.Infra
{
    /// <summary>
    /// Represents Retaline engine
    /// </summary>
    public partial class RetalineEngine : IEngine
    {
        #region Utilities
        ...
        public virtual void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            try
            {
                ...
                var typeFinder = Singleton<ITypeFinder>.Instance;
                var startupConfigurations = typeFinder?.FindClassesOfType<IRetalineStartup>();

                //create and sort instances of startup configurations
                var instances = startupConfigurations?
                    .Select(startup => (IRetalineStartup)Activator.CreateInstance(startup))
