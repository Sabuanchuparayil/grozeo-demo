...
using Retaline.Core.Events;
using Retaline.Core.Infra;
using Retaline.Core.Services.Events;

namespace Retaline.Core.Services.Caching
{
    /// <summary>
        ...
        where TEntity : BaseEntity
    {
        ...
        {
            await RemoveByPrefixAsync(RetalineEntityCacheDefaults<TEntity>.ByIdsPrefix);
            await RemoveByPrefixAsync(RetalineEntityCacheDefaults<TEntity>.AllPrefix);

            if (entityEventType != EntityEventType.Insert)
                await RemoveAsync(RetalineEntityCacheDefaults<TEntity>.ByIdCacheKey, entity);
