...
namespace Retaline.Core.Services.Common
{
    ...
    public partial interface IGenericAttributeService
    {
        ...
        Task<TPropType> GetAttributeAsync<TPropType>(int entityId, string keyGroup, string key, int storeId = 0, TPropType defaultValue = default);
        Task SaveAttributeAsync<TPropType>(int entityId, string keyGroup, string key, TPropType value, int storeId = 0);
    }
}