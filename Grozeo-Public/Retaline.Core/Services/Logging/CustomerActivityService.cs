...
namespace Retaline.Core.Services.Logging
{
    ...
    public partial class CustomerActivityService : ICustomerActivityService
    {
        ...
        /// The task result contains the activity log item
        /// </returns>
        public virtual async Task<ActivityLog> InsertActivityAsync(User customer, string systemKeyword, string comment, BaseEntity entity = null)
        {
            if (customer == null)
                return null;
            ...
            var logItem = new ActivityLog
            {
                ...
                Comment = Utilities.Common.EnsureMaximumLength(comment ?? string.Empty, 4000),
        ...
        /// </returns>
        public virtual async Task<IList<ActivityLog>> GetAllActivitiesAsync(DateTime? createdOnFrom = null, DateTime? createdOnTo = null,
