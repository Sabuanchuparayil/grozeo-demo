...
using Retaline.Core;
//using Retaline.Core.Domain.Customers;
...
namespace Retaline.Core.Services.Logging
{
    ...
    public partial interface ICustomerActivityService
    {
        ...
        /// The task result contains the activity log item
        /// </returns>
        Task<ActivityLog> InsertActivityAsync(User customer, string systemKeyword, string comment, BaseEntity entity = null);
        ...
        /// </returns>
        Task<IList<ActivityLog>> GetAllActivitiesAsync(DateTime? createdOnFrom = null, DateTime? createdOnTo = null,
