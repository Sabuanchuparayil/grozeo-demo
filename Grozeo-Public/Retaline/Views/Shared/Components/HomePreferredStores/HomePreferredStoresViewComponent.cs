...
{
    public class HomePreferredStoresViewComponent : ViewComponent
    {
        private readonly ICustomAuthenticationService _authenticationService;
        private readonly IProfileService _profileService;
        private readonly IConfiguration _configuration;

        public HomePreferredStoresViewComponent(ICustomAuthenticationService authenticationService, IProfileService profileService, IConfiguration configuration)
        {
