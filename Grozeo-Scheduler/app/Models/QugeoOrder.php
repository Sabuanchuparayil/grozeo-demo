...
use App\Status\{
    QugeoStatus,
    QugeoSourceOrderStatus
};
use App\Models\{
    Branch,
    TransferOrder,
    Drivers\DriveDeliveryStatus
};
...
class QugeoOrder extends Model
{
   ...
   //     file_put_contents('php://stderr', "getQugeoParentStatusUpdated -- Whats " . $updateurl . " -- " . $status . " -- " . $type . "\n");
    ...
    {
        return $this->belongsTo(TransferOrder::class, "quor_TransferOrder_id", "fsto_id");
    }
    ...
    {
        return $this->belongsTo(DriveDeliveryStatus::class, 'quor_Status', 'dls_ID');
    }
}
