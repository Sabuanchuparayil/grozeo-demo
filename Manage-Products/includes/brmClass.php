...
global $db;
        ...
        public function getDetails($id) {
            global $db;
            if (!empty($id)) {
                $db->_loadRecordJson("SELECT br_ID,br_Name, br_District, br_State,br_stockLevel,branch_shortname,br_cpd,br_storeGroup,br_ranking,            
					...
					br_Address,br_Fax,br_Email,br_Phone,br_Incharge,br_pincode,br_Lat,br_Lng, br_RetailType,br_rdrIdExpress,br_rdrIdSlotted,br_rdrIdCourier 
