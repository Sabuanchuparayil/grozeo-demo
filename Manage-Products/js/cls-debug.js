...
Cls.menu.TimeFieldMenu = function(config){
    Cls.menu.TimeFieldMenu.superclass.constructor.call(this, config);
    this.plain = true;
    var di = new Cls.menu.TimeFieldItem(config);
    this.add(di);
...
Ext.extend(Cls.menu.TimeFieldMenu, Ext.menu.Menu, {
...
Cls.menu.TimeFieldItem = function(config){
    Cls.menu.TimeFieldItem.superclass.constructor.call(this, Ext.ComponentMgr.create(config,"timepicker"+config.timeField), config);
...
Ext.extend(Cls.menu.TimeFieldItem, Ext.menu.Adapter, {
    // private
    onSelect : function(picker, date){
        this.fireEvent("select", this, date, picker);
        Cls.menu.TimeFieldItem.superclass.handleClick.call(this);
    }
});
