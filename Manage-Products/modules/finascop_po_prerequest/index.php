...
switch ($op) {
    ...
    case 'saveItemPOPreqDetails':
        $adhocCount = $db->getItemSafe("SELECT COUNT(*) FROM finascop_purchase_order_poprereq WHERE prereq_uniqueid = ? AND prereq_updatedon = '{$_POST['poprereq_updatedon']}'", "s", [$_POST['fpopredet_uniqueid']]);
