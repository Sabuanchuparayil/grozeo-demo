    ...
    var getB2CSalesDetailReportGrid = function () {
        ...
        var getB2CSalesDetailsReportStore = function () {
            var SculptueReportStore = new Ext.data.JsonStore({
                ...
                fields: ['order_order_id', 'stiid_id', 'br_Name', 'fpo_id', 'fpo_vendorName', 'fpo_poNumber', 'fpo_poDate', 'stiid_barcode', 'stiid_itemmastername', 'stiid_expirydate', 'stiid_batchno', 'created_at',
                    'cpd_branch_id', 'stiid_leastSKUmrp', 'payMode'],
                totalProperty: 'totalCount',
                root: 'data',
                autoLoad: true,
                remoteSort: true,
