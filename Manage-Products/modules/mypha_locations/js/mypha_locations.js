...
Application.MyphaLocations = function () {
    var winsize = Ext.getBody().getViewSize();
    var modURL = '?module=mypha_locations';
    ...
    var gridSelectionChangedstates = function (sm) {
        if (!Ext.isEmpty(Ext.getCmp('gridpanelMasterDataviewStatedata').getSelectionModel().getSelections())) {
            var ID = Ext.getCmp('gridpanelMasterDataviewStatedata').getSelectionModel().getSelections()[0].data.state_id;
            Application.MyphaLocations.ViewStates(ID);
        }
    };
    ...
    var gridSelectionChangeddistrict = function (sm) {
        if (!Ext.isEmpty(Ext.getCmp('gridpanelMasterDataviewAddDistrictdata').getSelectionModel().getSelections())) {
            var ID = Ext.getCmp('gridpanelMasterDataviewAddDistrictdata').getSelectionModel().getSelections()[0].data.district_id;
            Application.MyphaLocations.ViewDistricts(ID);
        }
    };

    var gridSelectionChangedcountry = function (sm) {
        if (!Ext.isEmpty(Ext.getCmp('gridpanelOrginDataviewCountrydata').getSelectionModel().getSelections())) {
            var ID = Ext.getCmp('gridpanelOrginDataviewCountrydata').getSelectionModel().getSelections()[0].data.country_id;
            Application.MyphaLocations.ViewCountry(ID);
        }
    };

    var saveDistrictData =  function () {
        if (!Ext.isEmpty(Ext.getCmp('district_name').getValue() && Ext.getCmp('comboMasterDistrictStatus').getValue())) {
            Ext.Ajax.request({
                    url: modURL + '&op=saveDistrict',
                    method: 'POST',
                    params: {
                        id: Ext.getCmp('district_id').getValue(),
                        state_id: Ext.getCmp('textfieldstateid').getValue(),
                        name: Ext.getCmp('district_name').getValue(),
                    ...
                    success: function (response) {
                        ...
                        if (tmp.success === true && tmp.valid === true) {
                            ...
                            if (Application.MyphaLocations.DistrictAddEdit == 'Add') {
                            ...
                            Application.MyphaLocations.DistrictAddEdit = '';

                            Application.MyphaLocations.ViewDistricts(tmp.data.district_id);
    ...
    var saveStateData = function () {
        if (!Ext.isEmpty(Ext.getCmp('state_name').getValue() && Ext.getCmp('state_code').getValue() && Ext.getCmp('comboMasterStateStatus').getValue())) {
            Ext.Ajax.request({
                    url: modURL + '&op=saveStates',
                    method: 'POST',
                    params: {
                        id: Ext.getCmp('state_id').getValue(),
                        name: Ext.getCmp('state_name').getValue(),
                    ...
                    success: function (response) {
                        ...
                        if (tmp.success === true && tmp.valid === true) {
                            Application.example.msg('Success', tmp.message);
                            if (Application.MyphaLocations.StateAddEdit == 'Add') {
                            ...
                            Application.MyphaLocations.StateAddEdit = '';
                            Application.MyphaLocations.ViewStates(tmp.data.state_id);
                        } else if (tmp.success === true && tmp.valid === false) {
                            Ext.Msg.alert("Notification.", tmp.message);
                        } else if (tmp.success === true && tmp.img_valid === false) {
                            Ext.Msg.alert("Notification.", tmp.message);
        ...
        var saveCountryData =  function () {
            if (!Ext.isEmpty(Ext.getCmp('textfieldOrginCountryName').getValue() && 
                Ext.getCmp('textfieldBrmlocationCountryCode').getValue() && 
                Ext.getCmp('comboCntryOrginStatus').getValue())) {
                Ext.Ajax.request({
                        url: modURL + '&op=saveCountryDetails',
                        method: 'POST',
                        params: {
                            id: Ext.getCmp('country_id').getValue(),
                            name: Ext.getCmp('textfieldOrginCountryName').getValue(),
                            code: Ext.getCmp('textfieldBrmlocationCountryCode').getValue(),
                            status: Ext.getCmp('comboCntryOrginStatus').getValue()
                        ...
                        success: function (response) {
                            ...
                            if (tmp.success === true && tmp.valid === true) {
                                Application.example.msg('Success', tmp.message);
                                if (Application.MyphaLocations.StateAddEdit == 'Add') {
                                    RECS_PER_PAGE = updateRecsPerPage(Ext.getCmp('gridpanelOrginDataviewCountrydata'));
                                    Ext.getCmp('formpanelCountryOrgin').getForm().reset();
                                    Ext.getCmp('gridpanelOrginDataviewCountrydata').store.reload({
                                        params: {
                                            start: 0,
                                            limit: RECS_PER_PAGE
                                        }
                                    ...
                                    Ext.getCmp('gridpanelOrginDataviewCountrydata').selModel.getSelected().data = tmp.data;
                                    Ext.getCmp('gridpanelOrginDataviewCountrydata').getStore().reload();
                                    Ext.getCmp('gridpanelOrginDataviewCountrydata').getView().refresh();
                                }
                                Application.MyphaLocations.StateAddEdit = '';
                                Application.MyphaLocations.ViewCountry(tmp.data.country_id);
                            } else if (tmp.success === true && tmp.valid === false) {
                                Ext.Msg.alert("Notification.", tmp.message);
                            } else if (tmp.success === true && tmp.img_valid === false) {
                                Ext.Msg.alert("Notification.", tmp.message);
    ...
    var StateForm = function () {
        var _stateFormPanel = new Ext.form.FormPanel({
            ...
            buttonAlign: 'right',
            fbar: [/*<?php if (user_access("mypha_locations", "saveStates")) { ?> */
                {
                    text: "Save",
                    tabIndex: 4,
            ...
            listeners: {
                afterrender: function () {
                    if (Ext.isEmpty(Ext.getCmp('state_id').getValue())) {
    ...
    var StateMasterDetailsView = function () {
        return new Ext.Panel({
            ...
            tpl: new Ext.XTemplate('<div class="details-outer">',
                    ...
                    '<tr><th width="40%">State Name </th><td>  {state_name} </td></tr>',
            ...
            fbar: [/*<?php if (user_access("mypha_locations", "saveStates")) { ?> */
                {
                    ...
                    handler: function () {
                        var ID = Ext.getCmp('gridpanelMasterDataviewStatedata').getSelectionModel().getSelections()[0].data.state_id;
                        Application.MyphaLocations.EditStatesView(ID);
                    }
                }/*<?php } ?> */
    ...
    var StateMasterStore = function () {
        ...
        var _stateMasterStore = new Ext.data.GroupingStore({
            ...
            reader: new Ext.data.JsonReader({
                ...
                idProperty: 'state_id',
                root: 'data'
            }, ['state_id', 'state_name', 'state_code', 'status', 'location']),
            sortInfo: {
                field: 'state_id',
                direction: "DESC"
            },
        ...
        var _statemaingridPanel = new Ext.grid.GridPanel({
            ...
            listeners: {
                cellClick: function (grid, rowIndex, columnIndex, e) {
                    ...
                    Ext.getCmp('textfieldstateid').setValue(record.data.state_id);

                    var ID = record.get('state_id');
                    if (!Ext.isEmpty(ID)) {
                        Application.MyphaLocations.Cache.state_id = ID;
            ...
            tbar: [{
                    ...
                    iconCls: 'my-icon1',
                    handler: function () {
                        Application.MyphaLocations.StateAddEdit = 'Add';
                        var stateForm = Ext.getCmp('formpanelMasterState').getForm();
                        Ext.getCmp('panelMasterStateParent').setTitle('Add State Details');
                        loadedForm = null;
                        stateForm.reset();
                        Ext.getCmp('state_name').focus(false, 100);
                        Ext.getCmp('buttonMasterStateEdit').hide();
                        Ext.getCmp('buttonMasterStateSave').show();
                        Ext.getCmp('buttonMasterStateCancel').show();
                        Ext.getCmp('formpanelMasterState').show();
                        Ext.getCmp('comboMasterStateStatus').setValue(1);
    ...
    var DistrictForm = function () {
        var _stateFormPanel = new Ext.form.FormPanel({
            ...
            buttonAlign: 'right',
            fbar: [/*<?php if (user_access("mypha_locations", "saveDistrict")) { ?> */
                {
                    text: "Save",
                    tabIndex: 4,
                    cls: 'left-right-buttons',
            ...
            listeners: {
                afterrender: function () {
                    if (Ext.isEmpty(Ext.getCmp('district_id').getValue())) {
    ...
    var DistrictMasterDetailsView = function () {
        return new Ext.Panel({
            ...
            tpl: new Ext.XTemplate('<div class="details-outer">',
                    '<table border="0" width="100%" class="details_view_table">',
                    '<tr><th width="40%">District Name </th><td>  {district_name} </td></tr>',
                    '<tr><th width="40%">Status</th><td>',
                    '<tpl if="status == \'1\'">Active</tpl>',
                    '<tpl if="status == \'0\'">Inactive</tpl>',
                    '</td></tr>',
            ...
            fbar: [/*<?php if (user_access("mypha_locations", "saveDistrict")) { ?> */
                {
                    ...
                    handler: function () {
                        var ID = Ext.getCmp('gridpanelMasterDataviewAddDistrictdata').getSelectionModel().getSelections()[0].data.district_id;
                        Application.MyphaLocations.EditDistrictView(ID);
                    }
                }
                /*<?php } ?> */
    ...
    var DistrictMasterDistrictView = function () {
        var state_id = arguments[0];
        var _districtStore = DistrictAddMasterStore(state_id);
    ...
    var DistrictAddWindow = function () {
        ...
        var po_add_form = masterPanelforDistrict(state_id, country_id);
    ...
    var masterPanelforDistrict = function () {
        ...
        var _mpanelforState = new Ext.Panel({
            ...
            items: [DistrictMasterAddDistrictView(state_id, country_id, gridId), new Ext.Panel({
    ...
    var DistrictMasterAddDistrictView = function () {
        ...
        var country_id = arguments[1];
        var gridId = 1;
        var _districtStore = DistrictAddMasterStore(state_id, country_id, gridId);
        var _districtGridFilter = new Ext.ux.grid.GridFilters({
            filters: [{
                    type: 'string',
                    dataIndex: 'district_name'
        ...
        var _districtmaingridPanel = new Ext.grid.GridPanel({
            ...
            tbar: [{
                    ...
                    iconCls: 'my-icon1',
                    handler: function () {
                        Application.MyphaLocations.DistrictAddEdit = 'Add';
                        var districtForm = Ext.getCmp('formpanelMasterDistrict').getForm();
                        Ext.getCmp('panelMasterDistricAddParent').setTitle('Add District Details');
                        loadedForm = null;
                        districtForm.reset();
                        Ext.getCmp('district_name').focus(false, 100);
                        ...
                        Ext.getCmp('comboMasterDistrictStatus').setValue(1);
    ...
    var DistrictAddMasterStore = function () {
        ...
        var _districtMasterStore = new Ext.data.GroupingStore({
            ...
            reader: new Ext.data.JsonReader({
                ...
                root: 'data'
            }, ['district_id', 'district_name', 'status']),
            sortInfo: {
                field: 'district_id',
                direction: "DESC"
            },
    ...
    var CountryForm = function () {
        var _countryFormPanel = new Ext.form.FormPanel({
            ...
            fbar: [
                ...
                /*<?php if (user_access("mypha_locations", "saveCountryDetails")) { ?> */
                {
                    text: "Save",
                    tabIndex: 4,
                    cls: 'left-right-buttons',
            ...
            listeners: {
                afterrender: function () {
                    if (Ext.isEmpty(Ext.getCmp('country_id').getValue())) {
                        var recordSelected = Ext.getCmp('comboCntryOrginStatus').getStore().getAt(0);
                        Ext.getCmp('comboCntryOrginStatus').setValue(recordSelected.get('id'));
                    }
                }
            }
        });
    ...
    var CountryMasterDetailsView = function () {
        return new Ext.Panel({
            ...
            autoHeight: true,
            //height: 150,
            id: 'panelOrginCountryDetailsView',
            tpl: new Ext.XTemplate('<div class="details-outer">',
                    '<table border="0" width="100%" class="details_view_table">',
                    ...
                    '</div>'),
            buttonAlign: 'right',
            fbar: [/*<?php if (user_access("mypha_locations", "saveCountryDetails")) { ?> */
                {
                    text: "Edit",
                    cls: 'left-right-buttons',
                    ...
                    handler: function () {
                        ...
                        var ID = Ext.getCmp('gridpanelOrginDataviewCountrydata').getSelectionModel().getSelections()[0].data.country_id;
                        Application.MyphaLocations.EditCountryView(ID);
                    }
                }
                /*<?php } ?> */
            ]
    ...
    var CountryBrmStore = function () {
        var _countryStore = new Ext.data.GroupingStore({
            ...
            listeners: {
                load: function () {
                    Ext.getCmp('gridpanelOrginDataviewCountrydata').getView().refresh();
                    Ext.getCmp('gridpanelOrginDataviewCountrydata').getSelectionModel().selectRow(0);
                }
            }
        });
    ...
    var CountryMainGrid = function () {
        ...
        var __countrymaingridPanel = new Ext.grid.GridPanel({
            ...
            store: _countryStore,
            //iconCls: 'money',
            id: 'gridpanelOrginDataviewCountrydata',
            view: new Ext.grid.GroupingView({
                forceFit: true,
                deferEmptyText: false,
                emptyText: '<div class="grid-data-empty"><div data-icon="/" class="empty-grid-icon"></div><div class="empty-grid-headline"></div><div class="empty-grid-byline">There are no records to show you right now.</div></div>',
            ...
            listeners: {
                cellClick: function (grid, rowIndex, columnIndex, e) {
                    ...
                    if (!Ext.isEmpty(ID)) {
                        Application.MyphaLocations.Cache.country_id = ID;
                        Ext.getCmp('formpanelCountryOrgin').hide();
                        Application.MyphaLocations.ViewCountry(ID);
            ...
            tbar: [{
                    text: 'Create Country of Origin',
                    tooltip: 'Create Country of Origin',
                    icon: './resources/images/default/icons/add.png',
                    iconCls: 'my-icon1',
                    handler: function () {
                        Application.MyphaLocations.StateAddEdit = 'Add';
                        var countryForm = Ext.getCmp('formpanelCountryOrgin').getForm();
                        Ext.getCmp('panelOrginCountryParent').setTitle('Create Country Details');
                        loadedForm = null;
                        countryForm.reset();
                        Ext.getCmp('textfieldOrginCountryName').focus(false, 100);
                        /*<?php if (user_access("mypha_locations", "saveCountryDetails")) { ?> */
                        Ext.getCmp('buttonBrmLocationCountryEdit').hide();
                        Ext.getCmp('buttonBrmLocationCountrySave').show();
                        Ext.getCmp('buttonBrmLocationCountryCancel').show();
                        /*<?php } ?> */
                        Ext.getCmp('formpanelCountryOrgin').show();
                        Ext.getCmp('comboCntryOrginStatus').setValue(1);
                        Ext.getCmp('panelOrginCountryDetailsView').hide();
                        Ext.getCmp('panelOrginCountryParent').doLayout();
                    }
                }]
        });
    ...
    var masterPanelforCountryOrgin = function (id) {
        var _mpanelforCountry = new Ext.Panel({
            frame: false,
            hideBorders: true,
            layout: 'border',
...
//                    }
    ...
    return {
        ...
        ViewStates: function () {
            var state_id = arguments[0];
            /*<?php if (user_access("mypha_locations", "saveStates")) { ?> */
            ...
            Ext.Ajax.request({
                ...
                success: function (res) {
                    ...
                    Ext.getCmp('textfieldstateid').setValue(state_id);
        ...
        EditStatesView: function () {
            Application.MyphaLocations.StateAddEdit = 'Edit';
            Ext.getCmp('panelMasterStateParent').doLayout();
        ...
        initCountry: function () {
            var _CountryPanelId = 'panelMasterMainCountryOrgin';
            var _masterPanelCountry = Ext.getCmp(_CountryPanelId);
            if (Ext.isEmpty(_masterPanelCountry)) {
                _masterPanelCountry = masterPanelforCountryOrgin(_CountryPanelId);
                Application.UI.addTab(_masterPanelCountry);
                _masterPanelCountry.doLayout();
            } else {
                Application.UI.addTab(_masterPanelCountry);
        ...
        ViewCountry: function () {
            ...
            Ext.getCmp('formpanelCountryOrgin').hide();
            Ext.getCmp('panelOrginCountryDetailsView').show();
            //Ext.getCmp('panelBrmLocationStateParent').show();
            Ext.getCmp('panelOrginCountryParent').doLayout();
            Ext.getCmp('panelOrginCountryParent').setTitle('View Country Details');
            ...
            Ext.Ajax.request({
                ...
                success: function (res) {
                    var tmp = Ext.decode(res.responseText);
                    if (tmp.success === true) {
                        var visualsDescPanel = Ext.getCmp('panelOrginCountryDetailsView');
                        visualsDescPanel.update(tmp);
                    }
        ...
        EditCountryView: function () {
            ...
            Application.MyphaLocations.StateAddEdit = 'Edit';
            Ext.getCmp('panelOrginCountryParent').doLayout();
            Ext.getCmp('panelOrginCountryParent').setTitle('Edit Country Details');
            Ext.getCmp('formpanelCountryOrgin').show();
            //Ext.getCmp('panelBrmLocationStateParent').show();
            Ext.getCmp('panelOrginCountryDetailsView').hide();
            /*<?php if (user_access("mypha_locations", "saveCountryDetails")) { ?> */
            ...
            var t_stamp = t.format("YmdHis");
            if (!Ext.isEmpty(arguments[0])) {
                var hnsForm = Ext.getCmp('formpanelCountryOrgin').getForm();
                hnsForm.load({
                    params: {
