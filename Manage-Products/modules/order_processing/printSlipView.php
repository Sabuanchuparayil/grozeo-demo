            ...
            <div class="left-area-block">
                <?php for ($p = 1; $p <= $printCount; $p++) { ?>
                    <table border="1" cellspacing="0" cellpadding="0" class="ship-detail-table">
                        ...
                        <tr>
                                <td rowspan="5">
                                    <div>Order No : <span class="bal"><strong><?php echo $order_order_id; ?></strong></span> / No of packets: <span class="bal"><strong><?php echo $p . ' - ' . $customerOrderDetails['order_packedbags_count']; ?></strong></span></div>
                                </td>
                                <td rowspan="5">
