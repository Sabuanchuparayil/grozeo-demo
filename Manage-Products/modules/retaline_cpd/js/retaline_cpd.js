Application.CPD = function () {
    ...
    var godownExecutiveStore = function () {
        ...
        var godownBoy_store = new Ext.data.JsonStore({
            proxy: proxy,
            fields: ['id', 'name', 'phone', 'cpd_name', 'status', 'is_cpd', 'is_offline', 'latlng_updated_at', 'is_allowManualSchedule', 'is_allowAutoSchedule'],
            totalProperty: 'totalCount',
            root: 'data',
            id: 'id',
            remoteSort: false,
            ...
            godownExecutive_window = new Ext.Window({
                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        iconCls: 'my-icon1',
                        handler: function () {
                            var is_allowManualSchedule, is_allowAutoSchedule;
