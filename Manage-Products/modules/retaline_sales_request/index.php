...
//echo json_encode($data);
    ...
    case 'saveB2BSRItemDetails':
        ...
        $adhocCount = $db->getItemSafe("SELECT COUNT(*) FROM retaline_B2B_SalesRequest_adhoc WHERE adhoc_uniqueid = ? AND adhoc_updatedon = '{$_POST['sradhoc_updatedon']}'", "s", [$_POST['b2bsr_UniqueID']]);
