   ...
   */
    ...
    createGrid : function()
    {
        ...
        this.grid_panel = new Ext.grid.GridPanel({
            ...
            tbar : [{
                xtype: 'checkbox',
                boxLabel:'Application Server',
                name: 'appserver',
                tabIndex: 181,
                inputValue: 'appServer',
                id: 'appserver',
                listeners:{
                    check: function(){
                        store.baseParams = {
                            appserver : Ext.getCmp('appserver').getValue()
                        }
            ...
            //value: 'appser'
                ...
                xtype: 'checkbox',
                boxLabel:'Application Client',
                name: 'appclient',
                inputValue: 'appClient',
                id: 'appclient',
                tabIndex: 182,
                listeners:{
                    check: function(){
                        ...
                        store.baseParams = {
                            ...
                            appclient : Ext.getCmp('appclient').getValue()
                        }
    ...
    updateToolbar : function()
    {
       ...
       * To remove abort button while uploading
       * Note: Commented the css,text&tooltip & added disable to upload button
       **/
      ...
      tb.x_buttons.upload.getEl()
        ...
        /****************************end; To remove abort button while uploading*/
        }
        else {
    ...
    uploadFile : function(record)
    {
        ...
        Ext.Ajax.request({
            url : this.url,
            params : {params:this.base_params || this.baseParams || this.params ,
                appserver:store.baseParams.appserver,
            appclient:store.baseParams.appclient},
            method : 'POST',
            form : this.form,
            isUpload : true,
